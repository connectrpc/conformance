...
ifeq ($(NPM_TOKEN),)
	...
	TEST_LATEST_COMMIT=$(TEST_LATEST_COMMIT) docker-compose run client-connect-to-server-connect-h2
	TEST_LATEST_COMMIT=$(TEST_LATEST_COMMIT) docker-compose run client-connect-to-server-connect-h3
