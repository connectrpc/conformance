...
func runUnary4(client conformancev1alpha1connect.ConformanceServiceClient) {
	fmt.Println("runUnary4 (no headers/trailers) --------")
	req := connect.NewRequest(&v1alpha1.UnaryRequest{
		ResponseDefinition: &v1alpha1.UnaryResponseDefinition{
			Response: nil,
		},
...
func runClientStream(client conformancev1alpha1connect.ConformanceServiceClient) {
	runClientStream1(client)
	runClientStream2(client)
}

func runClientStream1(client conformancev1alpha1connect.ConformanceServiceClient) {
	fmt.Println("runClientStream1 (happy path w/ no error) --------")
	req := &v1alpha1.ClientStreamRequest{
		ResponseDefinition: &v1alpha1.UnaryResponseDefinition{
			Response: &v1alpha1.UnaryResponseDefinition_ResponseData{
				ResponseData: []byte("test response"),
			},
	...
	// stream.Send(&v1alpha1.ClientStreamRequest{
	// 	Extra: []byte("second request"),
	// })
	fmt.Println("Sending third message")
	// stream.Send(&v1alpha1.ClientStreamRequest{
	// 	Extra: []byte("third request"),
	// })
...
func runClientStream2(client conformancev1alpha1connect.ConformanceServiceClient) {
	fmt.Println("runClientStream2 (happy path w/ error) --------")
	retryInfo := &errdetails.RetryInfo{
		RetryDelay: durationpb.New(10 * time.Second),
	}
	retryAny, err := anypb.New(retryInfo)
