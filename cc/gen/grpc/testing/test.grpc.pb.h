...
#ifndef GRPC_grpc_2ftesting_2ftest_2eproto__INCLUDED
#define GRPC_grpc_2ftesting_2ftest_2eproto__INCLUDED
 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    virtual ::grpc::Status FailUnaryCall(::grpc::ClientContext* context, const ::grpc::testing::SimpleRequest& request, ::grpc::testing::SimpleResponse* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::grpc::testing::SimpleResponse>> AsyncFailUnaryCall(::grpc::ClientContext* context, const ::grpc::testing::SimpleRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::grpc::testing::SimpleResponse>>(AsyncFailUnaryCallRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::grpc::testing::SimpleResponse>> PrepareAsyncFailUnaryCall(::grpc::ClientContext* context, const ::grpc::testing::SimpleRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::grpc::testing::SimpleResponse>>(PrepareAsyncFailUnaryCallRaw(context, request, cq));
    }
    ...
    std::unique_ptr< ::grpc::ClientReaderInterface< ::grpc::testing::StreamingOutputCallResponse>> FailStreamingOutputCall(::grpc::ClientContext* context, const ::grpc::testing::StreamingOutputCallRequest& request) {
      return std::unique_ptr< ::grpc::ClientReaderInterface< ::grpc::testing::StreamingOutputCallResponse>>(FailStreamingOutputCallRaw(context, request));
    }
    std::unique_ptr< ::grpc::ClientAsyncReaderInterface< ::grpc::testing::StreamingOutputCallResponse>> AsyncFailStreamingOutputCall(::grpc::ClientContext* context, const ::grpc::testing::StreamingOutputCallRequest& request, ::grpc::CompletionQueue* cq, void* tag) {
      return std::unique_ptr< ::grpc::ClientAsyncReaderInterface< ::grpc::testing::StreamingOutputCallResponse>>(AsyncFailStreamingOutputCallRaw(context, request, cq, tag));
    }
    std::unique_ptr< ::grpc::ClientAsyncReaderInterface< ::grpc::testing::StreamingOutputCallResponse>> PrepareAsyncFailStreamingOutputCall(::grpc::ClientContext* context, const ::grpc::testing::StreamingOutputCallRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncReaderInterface< ::grpc::testing::StreamingOutputCallResponse>>(PrepareAsyncFailStreamingOutputCallRaw(context, request, cq));
    }
    ...
    std::unique_ptr< ::grpc::ClientReaderInterface< ::grpc::testing::Empty>> UnimplementedStreamingOutputCall(::grpc::ClientContext* context, const ::grpc::testing::Empty& request) {
      return std::unique_ptr< ::grpc::ClientReaderInterface< ::grpc::testing::Empty>>(UnimplementedStreamingOutputCallRaw(context, request));
    }
    std::unique_ptr< ::grpc::ClientAsyncReaderInterface< ::grpc::testing::Empty>> AsyncUnimplementedStreamingOutputCall(::grpc::ClientContext* context, const ::grpc::testing::Empty& request, ::grpc::CompletionQueue* cq, void* tag) {
      return std::unique_ptr< ::grpc::ClientAsyncReaderInterface< ::grpc::testing::Empty>>(AsyncUnimplementedStreamingOutputCallRaw(context, request, cq, tag));
    }
    std::unique_ptr< ::grpc::ClientAsyncReaderInterface< ::grpc::testing::Empty>> PrepareAsyncUnimplementedStreamingOutputCall(::grpc::ClientContext* context, const ::grpc::testing::Empty& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncReaderInterface< ::grpc::testing::Empty>>(PrepareAsyncUnimplementedStreamingOutputCallRaw(context, request, cq));
    }
    class async_interface {
     public:
      virtual ~async_interface() {}
      // One empty request followed by one empty response.
      virtual void EmptyCall(::grpc::ClientContext* context, const ::grpc::testing::Empty* request, ::grpc::testing::Empty* response, std::function<void(::grpc::Status)>) = 0;
      virtual void EmptyCall(::grpc::ClientContext* context, const ::grpc::testing::Empty* request, ::grpc::testing::Empty* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      // One request followed by one response.
      virtual void UnaryCall(::grpc::ClientContext* context, const ::grpc::testing::SimpleRequest* request, ::grpc::testing::SimpleResponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void UnaryCall(::grpc::ClientContext* context, const ::grpc::testing::SimpleRequest* request, ::grpc::testing::SimpleResponse* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      // One request followed by one response. This RPC always fails.
      virtual void FailUnaryCall(::grpc::ClientContext* context, const ::grpc::testing::SimpleRequest* request, ::grpc::testing::SimpleResponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void FailUnaryCall(::grpc::ClientContext* context, const ::grpc::testing::SimpleRequest* request, ::grpc::testing::SimpleResponse* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      // One request followed by one response. Response has cache control
      // headers set such that a caching HTTP proxy (such as GFE) can
      // satisfy subsequent requests.
      virtual void CacheableUnaryCall(::grpc::ClientContext* context, const ::grpc::testing::SimpleRequest* request, ::grpc::testing::SimpleResponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void CacheableUnaryCall(::grpc::ClientContext* context, const ::grpc::testing::SimpleRequest* request, ::grpc::testing::SimpleResponse* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      // One request followed by a sequence of responses (streamed download).
      // The server returns the payload with client desired type and sizes.
      virtual void StreamingOutputCall(::grpc::ClientContext* context, const ::grpc::testing::StreamingOutputCallRequest* request, ::grpc::ClientReadReactor< ::grpc::testing::StreamingOutputCallResponse>* reactor) = 0;
      // One request followed by a sequence of responses (streamed download).
      // The server returns the payload with client desired type and sizes.
      // This RPC always responds with an error status.
      virtual void FailStreamingOutputCall(::grpc::ClientContext* context, const ::grpc::testing::StreamingOutputCallRequest* request, ::grpc::ClientReadReactor< ::grpc::testing::StreamingOutputCallResponse>* reactor) = 0;
      // A sequence of requests followed by one response (streamed upload).
      // The server returns the aggregated size of client payload as the result.
      virtual void StreamingInputCall(::grpc::ClientContext* context, ::grpc::testing::StreamingInputCallResponse* response, ::grpc::ClientWriteReactor< ::grpc::testing::StreamingInputCallRequest>* reactor) = 0;
      // A sequence of requests with each request served by the server immediately.
      // As one request could lead to multiple responses, this interface
      // demonstrates the idea of full duplexing.
      virtual void FullDuplexCall(::grpc::ClientContext* context, ::grpc::ClientBidiReactor< ::grpc::testing::StreamingOutputCallRequest,::grpc::testing::StreamingOutputCallResponse>* reactor) = 0;
      // A sequence of requests followed by a sequence of responses.
      // The server buffers all the client requests and then serves them in order. A
      // stream of responses are returned to the client when the server starts with
      // first request.
      virtual void HalfDuplexCall(::grpc::ClientContext* context, ::grpc::ClientBidiReactor< ::grpc::testing::StreamingOutputCallRequest,::grpc::testing::StreamingOutputCallResponse>* reactor) = 0;
      // The test server will not implement this method. It will be used
      // to test the behavior when clients call unimplemented methods.
      virtual void UnimplementedCall(::grpc::ClientContext* context, const ::grpc::testing::Empty* request, ::grpc::testing::Empty* response, std::function<void(::grpc::Status)>) = 0;
      virtual void UnimplementedCall(::grpc::ClientContext* context, const ::grpc::testing::Empty* request, ::grpc::testing::Empty* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      // The test server will not implement this method. It will be used
      // to test the behavior when clients call unimplemented streaming output methods.
      virtual void UnimplementedStreamingOutputCall(::grpc::ClientContext* context, const ::grpc::testing::Empty* request, ::grpc::ClientReadReactor< ::grpc::testing::Empty>* reactor) = 0;
    };
   ...
   private:
    ...
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::grpc::testing::SimpleResponse>* AsyncFailUnaryCallRaw(::grpc::ClientContext* context, const ::grpc::testing::SimpleRequest& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::grpc::testing::SimpleResponse>* PrepareAsyncFailUnaryCallRaw(::grpc::ClientContext* context, const ::grpc::testing::SimpleRequest& request, ::grpc::CompletionQueue* cq) = 0;
    ...
    virtual ::grpc::ClientReaderInterface< ::grpc::testing::StreamingOutputCallResponse>* FailStreamingOutputCallRaw(::grpc::ClientContext* context, const ::grpc::testing::StreamingOutputCallRequest& request) = 0;
    virtual ::grpc::ClientAsyncReaderInterface< ::grpc::testing::StreamingOutputCallResponse>* AsyncFailStreamingOutputCallRaw(::grpc::ClientContext* context, const ::grpc::testing::StreamingOutputCallRequest& request, ::grpc::CompletionQueue* cq, void* tag) = 0;
    virtual ::grpc::ClientAsyncReaderInterface< ::grpc::testing::StreamingOutputCallResponse>* PrepareAsyncFailStreamingOutputCallRaw(::grpc::ClientContext* context, const ::grpc::testing::StreamingOutputCallRequest& request, ::grpc::CompletionQueue* cq) = 0;
    ...
    virtual ::grpc::ClientReaderInterface< ::grpc::testing::Empty>* UnimplementedStreamingOutputCallRaw(::grpc::ClientContext* context, const ::grpc::testing::Empty& request) = 0;
    virtual ::grpc::ClientAsyncReaderInterface< ::grpc::testing::Empty>* AsyncUnimplementedStreamingOutputCallRaw(::grpc::ClientContext* context, const ::grpc::testing::Empty& request, ::grpc::CompletionQueue* cq, void* tag) = 0;
    virtual ::grpc::ClientAsyncReaderInterface< ::grpc::testing::Empty>* PrepareAsyncUnimplementedStreamingOutputCallRaw(::grpc::ClientContext* context, const ::grpc::testing::Empty& request, ::grpc::CompletionQueue* cq) = 0;
  };
  class Stub final : public StubInterface {
   public:
    ...
    ::grpc::Status FailUnaryCall(::grpc::ClientContext* context, const ::grpc::testing::SimpleRequest& request, ::grpc::testing::SimpleResponse* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::grpc::testing::SimpleResponse>> AsyncFailUnaryCall(::grpc::ClientContext* context, const ::grpc::testing::SimpleRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::grpc::testing::SimpleResponse>>(AsyncFailUnaryCallRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::grpc::testing::SimpleResponse>> PrepareAsyncFailUnaryCall(::grpc::ClientContext* context, const ::grpc::testing::SimpleRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::grpc::testing::SimpleResponse>>(PrepareAsyncFailUnaryCallRaw(context, request, cq));
    }
    ...
    std::unique_ptr< ::grpc::ClientReader< ::grpc::testing::StreamingOutputCallResponse>> FailStreamingOutputCall(::grpc::ClientContext* context, const ::grpc::testing::StreamingOutputCallRequest& request) {
      return std::unique_ptr< ::grpc::ClientReader< ::grpc::testing::StreamingOutputCallResponse>>(FailStreamingOutputCallRaw(context, request));
    }
    std::unique_ptr< ::grpc::ClientAsyncReader< ::grpc::testing::StreamingOutputCallResponse>> AsyncFailStreamingOutputCall(::grpc::ClientContext* context, const ::grpc::testing::StreamingOutputCallRequest& request, ::grpc::CompletionQueue* cq, void* tag) {
      return std::unique_ptr< ::grpc::ClientAsyncReader< ::grpc::testing::StreamingOutputCallResponse>>(AsyncFailStreamingOutputCallRaw(context, request, cq, tag));
    }
    std::unique_ptr< ::grpc::ClientAsyncReader< ::grpc::testing::StreamingOutputCallResponse>> PrepareAsyncFailStreamingOutputCall(::grpc::ClientContext* context, const ::grpc::testing::StreamingOutputCallRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncReader< ::grpc::testing::StreamingOutputCallResponse>>(PrepareAsyncFailStreamingOutputCallRaw(context, request, cq));
    }
    ...
    std::unique_ptr< ::grpc::ClientReader< ::grpc::testing::Empty>> UnimplementedStreamingOutputCall(::grpc::ClientContext* context, const ::grpc::testing::Empty& request) {
      return std::unique_ptr< ::grpc::ClientReader< ::grpc::testing::Empty>>(UnimplementedStreamingOutputCallRaw(context, request));
    }
    std::unique_ptr< ::grpc::ClientAsyncReader< ::grpc::testing::Empty>> AsyncUnimplementedStreamingOutputCall(::grpc::ClientContext* context, const ::grpc::testing::Empty& request, ::grpc::CompletionQueue* cq, void* tag) {
      return std::unique_ptr< ::grpc::ClientAsyncReader< ::grpc::testing::Empty>>(AsyncUnimplementedStreamingOutputCallRaw(context, request, cq, tag));
    }
    std::unique_ptr< ::grpc::ClientAsyncReader< ::grpc::testing::Empty>> PrepareAsyncUnimplementedStreamingOutputCall(::grpc::ClientContext* context, const ::grpc::testing::Empty& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncReader< ::grpc::testing::Empty>>(PrepareAsyncUnimplementedStreamingOutputCallRaw(context, request, cq));
    }
    class async final :
      public StubInterface::async_interface {
     public:
      void EmptyCall(::grpc::ClientContext* context, const ::grpc::testing::Empty* request, ::grpc::testing::Empty* response, std::function<void(::grpc::Status)>) override;
      void EmptyCall(::grpc::ClientContext* context, const ::grpc::testing::Empty* request, ::grpc::testing::Empty* response, ::grpc::ClientUnaryReactor* reactor) override;
      void UnaryCall(::grpc::ClientContext* context, const ::grpc::testing::SimpleRequest* request, ::grpc::testing::SimpleResponse* response, std::function<void(::grpc::Status)>) override;
      void UnaryCall(::grpc::ClientContext* context, const ::grpc::testing::SimpleRequest* request, ::grpc::testing::SimpleResponse* response, ::grpc::ClientUnaryReactor* reactor) override;
      void FailUnaryCall(::grpc::ClientContext* context, const ::grpc::testing::SimpleRequest* request, ::grpc::testing::SimpleResponse* response, std::function<void(::grpc::Status)>) override;
      void FailUnaryCall(::grpc::ClientContext* context, const ::grpc::testing::SimpleRequest* request, ::grpc::testing::SimpleResponse* response, ::grpc::ClientUnaryReactor* reactor) override;
      void CacheableUnaryCall(::grpc::ClientContext* context, const ::grpc::testing::SimpleRequest* request, ::grpc::testing::SimpleResponse* response, std::function<void(::grpc::Status)>) override;
      void CacheableUnaryCall(::grpc::ClientContext* context, const ::grpc::testing::SimpleRequest* request, ::grpc::testing::SimpleResponse* response, ::grpc::ClientUnaryReactor* reactor) override;
      void StreamingOutputCall(::grpc::ClientContext* context, const ::grpc::testing::StreamingOutputCallRequest* request, ::grpc::ClientReadReactor< ::grpc::testing::StreamingOutputCallResponse>* reactor) override;
      void FailStreamingOutputCall(::grpc::ClientContext* context, const ::grpc::testing::StreamingOutputCallRequest* request, ::grpc::ClientReadReactor< ::grpc::testing::StreamingOutputCallResponse>* reactor) override;
      void StreamingInputCall(::grpc::ClientContext* context, ::grpc::testing::StreamingInputCallResponse* response, ::grpc::ClientWriteReactor< ::grpc::testing::StreamingInputCallRequest>* reactor) override;
      void FullDuplexCall(::grpc::ClientContext* context, ::grpc::ClientBidiReactor< ::grpc::testing::StreamingOutputCallRequest,::grpc::testing::StreamingOutputCallResponse>* reactor) override;
      void HalfDuplexCall(::grpc::ClientContext* context, ::grpc::ClientBidiReactor< ::grpc::testing::StreamingOutputCallRequest,::grpc::testing::StreamingOutputCallResponse>* reactor) override;
      void UnimplementedCall(::grpc::ClientContext* context, const ::grpc::testing::Empty* request, ::grpc::testing::Empty* response, std::function<void(::grpc::Status)>) override;
      void UnimplementedCall(::grpc::ClientContext* context, const ::grpc::testing::Empty* request, ::grpc::testing::Empty* response, ::grpc::ClientUnaryReactor* reactor) override;
      void UnimplementedStreamingOutputCall(::grpc::ClientContext* context, const ::grpc::testing::Empty* request, ::grpc::ClientReadReactor< ::grpc::testing::Empty>* reactor) override;
     private:
      friend class Stub;
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::grpc::testing::SimpleResponse>* AsyncFailUnaryCallRaw(::grpc::ClientContext* context, const ::grpc::testing::SimpleRequest& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::grpc::testing::SimpleResponse>* PrepareAsyncFailUnaryCallRaw(::grpc::ClientContext* context, const ::grpc::testing::SimpleRequest& request, ::grpc::CompletionQueue* cq) override;
    ...
    ::grpc::ClientReader< ::grpc::testing::StreamingOutputCallResponse>* FailStreamingOutputCallRaw(::grpc::ClientContext* context, const ::grpc::testing::StreamingOutputCallRequest& request) override;
    ::grpc::ClientAsyncReader< ::grpc::testing::StreamingOutputCallResponse>* AsyncFailStreamingOutputCallRaw(::grpc::ClientContext* context, const ::grpc::testing::StreamingOutputCallRequest& request, ::grpc::CompletionQueue* cq, void* tag) override;
    ::grpc::ClientAsyncReader< ::grpc::testing::StreamingOutputCallResponse>* PrepareAsyncFailStreamingOutputCallRaw(::grpc::ClientContext* context, const ::grpc::testing::StreamingOutputCallRequest& request, ::grpc::CompletionQueue* cq) override;
    ...
    ::grpc::ClientReader< ::grpc::testing::Empty>* UnimplementedStreamingOutputCallRaw(::grpc::ClientContext* context, const ::grpc::testing::Empty& request) override;
    ::grpc::ClientAsyncReader< ::grpc::testing::Empty>* AsyncUnimplementedStreamingOutputCallRaw(::grpc::ClientContext* context, const ::grpc::testing::Empty& request, ::grpc::CompletionQueue* cq, void* tag) override;
    ::grpc::ClientAsyncReader< ::grpc::testing::Empty>* PrepareAsyncUnimplementedStreamingOutputCallRaw(::grpc::ClientContext* context, const ::grpc::testing::Empty& request, ::grpc::CompletionQueue* cq) override;
  ...
  class Service : public ::grpc::Service {
   public:
    ...
    // One request followed by one response. This RPC always fails.
    virtual ::grpc::Status FailUnaryCall(::grpc::ServerContext* context, const ::grpc::testing::SimpleRequest* request, ::grpc::testing::SimpleResponse* response);
    // One request followed by one response. Response has cache control
    // headers set such that a caching HTTP proxy (such as GFE) can
    // satisfy subsequent requests.
    ...
    // The server returns the payload with client desired type and sizes.
    // This RPC always responds with an error status.
    virtual ::grpc::Status FailStreamingOutputCall(::grpc::ServerContext* context, const ::grpc::testing::StreamingOutputCallRequest* request, ::grpc::ServerWriter< ::grpc::testing::StreamingOutputCallResponse>* writer);
    // A sequence of requests followed by one response (streamed upload).
    // The server returns the aggregated size of client payload as the result.
    ...
    // The test server will not implement this method. It will be used
    // to test the behavior when clients call unimplemented streaming output methods.
    virtual ::grpc::Status UnimplementedStreamingOutputCall(::grpc::ServerContext* context, const ::grpc::testing::Empty* request, ::grpc::ServerWriter< ::grpc::testing::Empty>* writer);
  };
  ...
  class WithAsyncMethod_FailUnaryCall : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status FailUnaryCall(::grpc::ServerContext* /*context*/, const ::grpc::testing::SimpleRequest* /*request*/, ::grpc::testing::SimpleResponse* /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestFailUnaryCall(::grpc::ServerContext* context, ::grpc::testing::SimpleRequest* request, ::grpc::ServerAsyncResponseWriter< ::grpc::testing::SimpleResponse>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
  ...
  class WithAsyncMethod_FailStreamingOutputCall : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status FailStreamingOutputCall(::grpc::ServerContext* /*context*/, const ::grpc::testing::StreamingOutputCallRequest* /*request*/, ::grpc::ServerWriter< ::grpc::testing::StreamingOutputCallResponse>* /*writer*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestFailStreamingOutputCall(::grpc::ServerContext* context, ::grpc::testing::StreamingOutputCallRequest* request, ::grpc::ServerAsyncWriter< ::grpc::testing::StreamingOutputCallResponse>* writer, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
  ...
  class WithAsyncMethod_UnimplementedStreamingOutputCall : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status UnimplementedStreamingOutputCall(::grpc::ServerContext* /*context*/, const ::grpc::testing::Empty* /*request*/, ::grpc::ServerWriter< ::grpc::testing::Empty>* /*writer*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestUnimplementedStreamingOutputCall(::grpc::ServerContext* context, ::grpc::testing::Empty* request, ::grpc::ServerAsyncWriter< ::grpc::testing::Empty>* writer, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
   ...
   public:
    WithCallbackMethod_EmptyCall() {
      ::grpc::Service::MarkMethodCallback(0,
          new ::grpc::internal::CallbackUnaryHandler< ::grpc::testing::Empty, ::grpc::testing::Empty>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::grpc::testing::Empty* request, ::grpc::testing::Empty* response) { return this->EmptyCall(context, request, response); }));}
    void SetMessageAllocatorFor_EmptyCall(
        ::grpc::MessageAllocator< ::grpc::testing::Empty, ::grpc::testing::Empty>* allocator) {
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(0);
      static_cast<::grpc::internal::CallbackUnaryHandler< ::grpc::testing::Empty, ::grpc::testing::Empty>*>(handler)
    ...
    virtual ::grpc::ServerUnaryReactor* EmptyCall(
      ::grpc::CallbackServerContext* /*context*/, const ::grpc::testing::Empty* /*request*/, ::grpc::testing::Empty* /*response*/)  { return nullptr; }
  };
  template <class BaseClass>
   ...
   public:
    WithCallbackMethod_UnaryCall() {
      ::grpc::Service::MarkMethodCallback(1,
          new ::grpc::internal::CallbackUnaryHandler< ::grpc::testing::SimpleRequest, ::grpc::testing::SimpleResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::grpc::testing::SimpleRequest* request, ::grpc::testing::SimpleResponse* response) { return this->UnaryCall(context, request, response); }));}
    void SetMessageAllocatorFor_UnaryCall(
        ::grpc::MessageAllocator< ::grpc::testing::SimpleRequest, ::grpc::testing::SimpleResponse>* allocator) {
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(1);
      static_cast<::grpc::internal::CallbackUnaryHandler< ::grpc::testing::SimpleRequest, ::grpc::testing::SimpleResponse>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ...
    virtual ::grpc::ServerUnaryReactor* UnaryCall(
      ::grpc::CallbackServerContext* /*context*/, const ::grpc::testing::SimpleRequest* /*request*/, ::grpc::testing::SimpleResponse* /*response*/)  { return nullptr; }
  };
  template <class BaseClass>
   ...
   public:
    WithCallbackMethod_FailUnaryCall() {
      ::grpc::Service::MarkMethodCallback(2,
          new ::grpc::internal::CallbackUnaryHandler< ::grpc::testing::SimpleRequest, ::grpc::testing::SimpleResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::grpc::testing::SimpleRequest* request, ::grpc::testing::SimpleResponse* response) { return this->FailUnaryCall(context, request, response); }));}
   ...
   public:
    WithCallbackMethod_CacheableUnaryCall() {
      ::grpc::Service::MarkMethodCallback(3,
          new ::grpc::internal::CallbackUnaryHandler< ::grpc::testing::SimpleRequest, ::grpc::testing::SimpleResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::grpc::testing::SimpleRequest* request, ::grpc::testing::SimpleResponse* response) { return this->CacheableUnaryCall(context, request, response); }));}
   ...
   public:
    WithCallbackMethod_StreamingOutputCall() {
      ::grpc::Service::MarkMethodCallback(4,
          new ::grpc::internal::CallbackServerStreamingHandler< ::grpc::testing::StreamingOutputCallRequest, ::grpc::testing::StreamingOutputCallResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::grpc::testing::StreamingOutputCallRequest* request) { return this->StreamingOutputCall(context, request); }));
    }
    ...
    virtual ::grpc::ServerWriteReactor< ::grpc::testing::StreamingOutputCallResponse>* StreamingOutputCall(
      ::grpc::CallbackServerContext* /*context*/, const ::grpc::testing::StreamingOutputCallRequest* /*request*/)  { return nullptr; }
  };
  template <class BaseClass>
   ...
   public:
    WithCallbackMethod_FailStreamingOutputCall() {
      ::grpc::Service::MarkMethodCallback(5,
          new ::grpc::internal::CallbackServerStreamingHandler< ::grpc::testing::StreamingOutputCallRequest, ::grpc::testing::StreamingOutputCallResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::grpc::testing::StreamingOutputCallRequest* request) { return this->FailStreamingOutputCall(context, request); }));
    }
    ...
    virtual ::grpc::ServerWriteReactor< ::grpc::testing::StreamingOutputCallResponse>* FailStreamingOutputCall(
      ::grpc::CallbackServerContext* /*context*/, const ::grpc::testing::StreamingOutputCallRequest* /*request*/)  { return nullptr; }
  };
  template <class BaseClass>
   ...
   public:
    WithCallbackMethod_StreamingInputCall() {
      ::grpc::Service::MarkMethodCallback(6,
          new ::grpc::internal::CallbackClientStreamingHandler< ::grpc::testing::StreamingInputCallRequest, ::grpc::testing::StreamingInputCallResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, ::grpc::testing::StreamingInputCallResponse* response) { return this->StreamingInputCall(context, response); }));
    }
    ...
    virtual ::grpc::ServerReadReactor< ::grpc::testing::StreamingInputCallRequest>* StreamingInputCall(
      ::grpc::CallbackServerContext* /*context*/, ::grpc::testing::StreamingInputCallResponse* /*response*/)  { return nullptr; }
  };
  template <class BaseClass>
   ...
   public:
    WithCallbackMethod_FullDuplexCall() {
      ::grpc::Service::MarkMethodCallback(7,
          new ::grpc::internal::CallbackBidiHandler< ::grpc::testing::StreamingOutputCallRequest, ::grpc::testing::StreamingOutputCallResponse>(
            [this](
    ...
    virtual ::grpc::ServerBidiReactor< ::grpc::testing::StreamingOutputCallRequest, ::grpc::testing::StreamingOutputCallResponse>* FullDuplexCall(
  ...
  class WithCallbackMethod_HalfDuplexCall : public BaseClass {
   ...
   public:
    ...
    virtual ::grpc::ServerBidiReactor< ::grpc::testing::StreamingOutputCallRequest, ::grpc::testing::StreamingOutputCallResponse>* HalfDuplexCall(
      ::grpc::CallbackServerContext* /*context*/)
      { return nullptr; }
  };
  template <class BaseClass>
   ...
   public:
    WithCallbackMethod_UnimplementedCall() {
      ::grpc::Service::MarkMethodCallback(9,
          new ::grpc::internal::CallbackUnaryHandler< ::grpc::testing::Empty, ::grpc::testing::Empty>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::grpc::testing::Empty* request, ::grpc::testing::Empty* response) { return this->UnimplementedCall(context, request, response); }));}
   ...
   public:
    WithCallbackMethod_UnimplementedStreamingOutputCall() {
      ::grpc::Service::MarkMethodCallback(10,
          new ::grpc::internal::CallbackServerStreamingHandler< ::grpc::testing::Empty, ::grpc::testing::Empty>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::grpc::testing::Empty* request) { return this->UnimplementedStreamingOutputCall(context, request); }));
    }
    ...
    virtual ::grpc::ServerWriteReactor< ::grpc::testing::Empty>* UnimplementedStreamingOutputCall(
      ::grpc::CallbackServerContext* /*context*/, const ::grpc::testing::Empty* /*request*/)  { return nullptr; }
  };
          ...
          ::grpc::testing::Empty, ::grpc::testing::Empty>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerUnaryStreamer<
                     ::grpc::testing::Empty, ::grpc::testing::Empty>* streamer) {
      ...
      ::grpc::Service::MarkMethodStreamed(1,
        new ::grpc::internal::StreamedUnaryHandler<
          ::grpc::testing::SimpleRequest, ::grpc::testing::SimpleResponse>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerUnaryStreamer<
                     ::grpc::testing::SimpleRequest, ::grpc::testing::SimpleResponse>* streamer) {
  ...
  class WithStreamedUnaryMethod_FailUnaryCall : public BaseClass {
   ...
   public:
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status StreamedFailUnaryCall(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::grpc::testing::SimpleRequest,::grpc::testing::SimpleResponse>* server_unary_streamer) = 0;
  };
  template <class BaseClass>
    ...
    WithSplitStreamingMethod_StreamingOutputCall() {
      ::grpc::Service::MarkMethodStreamed(4,
        new ::grpc::internal::SplitServerStreamingHandler<
          ::grpc::testing::StreamingOutputCallRequest, ::grpc::testing::StreamingOutputCallResponse>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerSplitStreamer<
                     ::grpc::testing::StreamingOutputCallRequest, ::grpc::testing::StreamingOutputCallResponse>* streamer) {
  ...
  class WithSplitStreamingMethod_FailStreamingOutputCall : public BaseClass {
   ...
   public:
    ...
    // replace default version of method with split streamed
    virtual ::grpc::Status StreamedFailStreamingOutputCall(::grpc::ServerContext* context, ::grpc::ServerSplitStreamer< ::grpc::testing::StreamingOutputCallRequest,::grpc::testing::StreamingOutputCallResponse>* server_split_streamer) = 0;
  };
  template <class BaseClass>
  class WithSplitStreamingMethod_UnimplementedStreamingOutputCall : public BaseClass {
   ...
   public:
    ...
    // replace default version of method with split streamed
    virtual ::grpc::Status StreamedUnimplementedStreamingOutputCall(::grpc::ServerContext* context, ::grpc::ServerSplitStreamer< ::grpc::testing::Empty,::grpc::testing::Empty>* server_split_streamer) = 0;
  };
  ...
  class StubInterface {
   public:
    ...
    class async_interface {
     public:
      virtual ~async_interface() {}
      virtual void Start(::grpc::ClientContext* context, const ::grpc::testing::ReconnectParams* request, ::grpc::testing::Empty* response, std::function<void(::grpc::Status)>) = 0;
      virtual void Start(::grpc::ClientContext* context, const ::grpc::testing::ReconnectParams* request, ::grpc::testing::Empty* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      virtual void Stop(::grpc::ClientContext* context, const ::grpc::testing::Empty* request, ::grpc::testing::ReconnectInfo* response, std::function<void(::grpc::Status)>) = 0;
      virtual void Stop(::grpc::ClientContext* context, const ::grpc::testing::Empty* request, ::grpc::testing::ReconnectInfo* response, ::grpc::ClientUnaryReactor* reactor) = 0;
    };
    typedef class async_interface experimental_async_interface;
    virtual class async_interface* async() { return nullptr; }
    class async_interface* experimental_async() { return async(); }
  ...
  class Stub final : public StubInterface {
   public:
    ...
    class async final :
      public StubInterface::async_interface {
     public:
      void Start(::grpc::ClientContext* context, const ::grpc::testing::ReconnectParams* request, ::grpc::testing::Empty* response, std::function<void(::grpc::Status)>) override;
      void Start(::grpc::ClientContext* context, const ::grpc::testing::ReconnectParams* request, ::grpc::testing::Empty* response, ::grpc::ClientUnaryReactor* reactor) override;
      void Stop(::grpc::ClientContext* context, const ::grpc::testing::Empty* request, ::grpc::testing::ReconnectInfo* response, std::function<void(::grpc::Status)>) override;
      void Stop(::grpc::ClientContext* context, const ::grpc::testing::Empty* request, ::grpc::testing::ReconnectInfo* response, ::grpc::ClientUnaryReactor* reactor) override;
     private:
      friend class Stub;
      explicit async(Stub* stub): stub_(stub) { }
      Stub* stub() { return stub_; }
  ...
  class WithCallbackMethod_Start : public BaseClass {
   ...
   public:
    WithCallbackMethod_Start() {
      ::grpc::Service::MarkMethodCallback(0,
          new ::grpc::internal::CallbackUnaryHandler< ::grpc::testing::ReconnectParams, ::grpc::testing::Empty>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::grpc::testing::ReconnectParams* request, ::grpc::testing::Empty* response) { return this->Start(context, request, response); }));}
    void SetMessageAllocatorFor_Start(
        ::grpc::MessageAllocator< ::grpc::testing::ReconnectParams, ::grpc::testing::Empty>* allocator) {
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(0);
      static_cast<::grpc::internal::CallbackUnaryHandler< ::grpc::testing::ReconnectParams, ::grpc::testing::Empty>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ...
    virtual ::grpc::ServerUnaryReactor* Start(
      ::grpc::CallbackServerContext* /*context*/, const ::grpc::testing::ReconnectParams* /*request*/, ::grpc::testing::Empty* /*response*/)  { return nullptr; }
  };
  template <class BaseClass>
  class WithCallbackMethod_Stop : public BaseClass {
   ...
   public:
    WithCallbackMethod_Stop() {
      ::grpc::Service::MarkMethodCallback(1,
          new ::grpc::internal::CallbackUnaryHandler< ::grpc::testing::Empty, ::grpc::testing::ReconnectInfo>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::grpc::testing::Empty* request, ::grpc::testing::ReconnectInfo* response) { return this->Stop(context, request, response); }));}
    void SetMessageAllocatorFor_Stop(
        ::grpc::MessageAllocator< ::grpc::testing::Empty, ::grpc::testing::ReconnectInfo>* allocator) {
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(1);
      static_cast<::grpc::internal::CallbackUnaryHandler< ::grpc::testing::Empty, ::grpc::testing::ReconnectInfo>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ...
    virtual ::grpc::ServerUnaryReactor* Stop(
      ::grpc::CallbackServerContext* /*context*/, const ::grpc::testing::Empty* /*request*/, ::grpc::testing::ReconnectInfo* /*response*/)  { return nullptr; }
  };
      ...
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::internal::StreamedUnaryHandler<
          ::grpc::testing::ReconnectParams, ::grpc::testing::Empty>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerUnaryStreamer<
                     ::grpc::testing::ReconnectParams, ::grpc::testing::Empty>* streamer) {
  ...
  class WithStreamedUnaryMethod_Stop : public BaseClass {
   ...
   public:
    WithStreamedUnaryMethod_Stop() {
      ::grpc::Service::MarkMethodStreamed(1,
        new ::grpc::internal::StreamedUnaryHandler<
          ::grpc::testing::Empty, ::grpc::testing::ReconnectInfo>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerUnaryStreamer<
                     ::grpc::testing::Empty, ::grpc::testing::ReconnectInfo>* streamer) {
...
class LoadBalancerStatsService final {
 public:
  static constexpr char const* service_full_name() {
    return "grpc.testing.LoadBalancerStatsService";
  }
  class StubInterface {
   public:
    virtual ~StubInterface() {}
    // Gets the backend distribution for RPCs sent by a test client.
    virtual ::grpc::Status GetClientStats(::grpc::ClientContext* context, const ::grpc::testing::LoadBalancerStatsRequest& request, ::grpc::testing::LoadBalancerStatsResponse* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::grpc::testing::LoadBalancerStatsResponse>> AsyncGetClientStats(::grpc::ClientContext* context, const ::grpc::testing::LoadBalancerStatsRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::grpc::testing::LoadBalancerStatsResponse>>(AsyncGetClientStatsRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::grpc::testing::LoadBalancerStatsResponse>> PrepareAsyncGetClientStats(::grpc::ClientContext* context, const ::grpc::testing::LoadBalancerStatsRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::grpc::testing::LoadBalancerStatsResponse>>(PrepareAsyncGetClientStatsRaw(context, request, cq));
    }
    // Gets the accumulated stats for RPCs sent by a test client.
    virtual ::grpc::Status GetClientAccumulatedStats(::grpc::ClientContext* context, const ::grpc::testing::LoadBalancerAccumulatedStatsRequest& request, ::grpc::testing::LoadBalancerAccumulatedStatsResponse* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::grpc::testing::LoadBalancerAccumulatedStatsResponse>> AsyncGetClientAccumulatedStats(::grpc::ClientContext* context, const ::grpc::testing::LoadBalancerAccumulatedStatsRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::grpc::testing::LoadBalancerAccumulatedStatsResponse>>(AsyncGetClientAccumulatedStatsRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::grpc::testing::LoadBalancerAccumulatedStatsResponse>> PrepareAsyncGetClientAccumulatedStats(::grpc::ClientContext* context, const ::grpc::testing::LoadBalancerAccumulatedStatsRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::grpc::testing::LoadBalancerAccumulatedStatsResponse>>(PrepareAsyncGetClientAccumulatedStatsRaw(context, request, cq));
    }
    class async_interface {
     public:
      virtual ~async_interface() {}
      // Gets the backend distribution for RPCs sent by a test client.
      virtual void GetClientStats(::grpc::ClientContext* context, const ::grpc::testing::LoadBalancerStatsRequest* request, ::grpc::testing::LoadBalancerStatsResponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void GetClientStats(::grpc::ClientContext* context, const ::grpc::testing::LoadBalancerStatsRequest* request, ::grpc::testing::LoadBalancerStatsResponse* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      // Gets the accumulated stats for RPCs sent by a test client.
      virtual void GetClientAccumulatedStats(::grpc::ClientContext* context, const ::grpc::testing::LoadBalancerAccumulatedStatsRequest* request, ::grpc::testing::LoadBalancerAccumulatedStatsResponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void GetClientAccumulatedStats(::grpc::ClientContext* context, const ::grpc::testing::LoadBalancerAccumulatedStatsRequest* request, ::grpc::testing::LoadBalancerAccumulatedStatsResponse* response, ::grpc::ClientUnaryReactor* reactor) = 0;
    };
    typedef class async_interface experimental_async_interface;
    virtual class async_interface* async() { return nullptr; }
    class async_interface* experimental_async() { return async(); }
   private:
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::grpc::testing::LoadBalancerStatsResponse>* AsyncGetClientStatsRaw(::grpc::ClientContext* context, const ::grpc::testing::LoadBalancerStatsRequest& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::grpc::testing::LoadBalancerStatsResponse>* PrepareAsyncGetClientStatsRaw(::grpc::ClientContext* context, const ::grpc::testing::LoadBalancerStatsRequest& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::grpc::testing::LoadBalancerAccumulatedStatsResponse>* AsyncGetClientAccumulatedStatsRaw(::grpc::ClientContext* context, const ::grpc::testing::LoadBalancerAccumulatedStatsRequest& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::grpc::testing::LoadBalancerAccumulatedStatsResponse>* PrepareAsyncGetClientAccumulatedStatsRaw(::grpc::ClientContext* context, const ::grpc::testing::LoadBalancerAccumulatedStatsRequest& request, ::grpc::CompletionQueue* cq) = 0;
  };
  class Stub final : public StubInterface {
   public:
    Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options = ::grpc::StubOptions());
    ::grpc::Status GetClientStats(::grpc::ClientContext* context, const ::grpc::testing::LoadBalancerStatsRequest& request, ::grpc::testing::LoadBalancerStatsResponse* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::grpc::testing::LoadBalancerStatsResponse>> AsyncGetClientStats(::grpc::ClientContext* context, const ::grpc::testing::LoadBalancerStatsRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::grpc::testing::LoadBalancerStatsResponse>>(AsyncGetClientStatsRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::grpc::testing::LoadBalancerStatsResponse>> PrepareAsyncGetClientStats(::grpc::ClientContext* context, const ::grpc::testing::LoadBalancerStatsRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::grpc::testing::LoadBalancerStatsResponse>>(PrepareAsyncGetClientStatsRaw(context, request, cq));
    }
    ::grpc::Status GetClientAccumulatedStats(::grpc::ClientContext* context, const ::grpc::testing::LoadBalancerAccumulatedStatsRequest& request, ::grpc::testing::LoadBalancerAccumulatedStatsResponse* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::grpc::testing::LoadBalancerAccumulatedStatsResponse>> AsyncGetClientAccumulatedStats(::grpc::ClientContext* context, const ::grpc::testing::LoadBalancerAccumulatedStatsRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::grpc::testing::LoadBalancerAccumulatedStatsResponse>>(AsyncGetClientAccumulatedStatsRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::grpc::testing::LoadBalancerAccumulatedStatsResponse>> PrepareAsyncGetClientAccumulatedStats(::grpc::ClientContext* context, const ::grpc::testing::LoadBalancerAccumulatedStatsRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::grpc::testing::LoadBalancerAccumulatedStatsResponse>>(PrepareAsyncGetClientAccumulatedStatsRaw(context, request, cq));
    }
    class async final :
      public StubInterface::async_interface {
     public:
      void GetClientStats(::grpc::ClientContext* context, const ::grpc::testing::LoadBalancerStatsRequest* request, ::grpc::testing::LoadBalancerStatsResponse* response, std::function<void(::grpc::Status)>) override;
      void GetClientStats(::grpc::ClientContext* context, const ::grpc::testing::LoadBalancerStatsRequest* request, ::grpc::testing::LoadBalancerStatsResponse* response, ::grpc::ClientUnaryReactor* reactor) override;
      void GetClientAccumulatedStats(::grpc::ClientContext* context, const ::grpc::testing::LoadBalancerAccumulatedStatsRequest* request, ::grpc::testing::LoadBalancerAccumulatedStatsResponse* response, std::function<void(::grpc::Status)>) override;
      void GetClientAccumulatedStats(::grpc::ClientContext* context, const ::grpc::testing::LoadBalancerAccumulatedStatsRequest* request, ::grpc::testing::LoadBalancerAccumulatedStatsResponse* response, ::grpc::ClientUnaryReactor* reactor) override;
     private:
      friend class Stub;
      explicit async(Stub* stub): stub_(stub) { }
      Stub* stub() { return stub_; }
   ...
   private:
    std::shared_ptr< ::grpc::ChannelInterface> channel_;
    class async async_stub_{this};
    ::grpc::ClientAsyncResponseReader< ::grpc::testing::LoadBalancerStatsResponse>* AsyncGetClientStatsRaw(::grpc::ClientContext* context, const ::grpc::testing::LoadBalancerStatsRequest& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::grpc::testing::LoadBalancerStatsResponse>* PrepareAsyncGetClientStatsRaw(::grpc::ClientContext* context, const ::grpc::testing::LoadBalancerStatsRequest& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::grpc::testing::LoadBalancerAccumulatedStatsResponse>* AsyncGetClientAccumulatedStatsRaw(::grpc::ClientContext* context, const ::grpc::testing::LoadBalancerAccumulatedStatsRequest& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::grpc::testing::LoadBalancerAccumulatedStatsResponse>* PrepareAsyncGetClientAccumulatedStatsRaw(::grpc::ClientContext* context, const ::grpc::testing::LoadBalancerAccumulatedStatsRequest& request, ::grpc::CompletionQueue* cq) override;
  ...
  class Service : public ::grpc::Service {
   public:
    ...
    virtual ~Service();
    // Gets the backend distribution for RPCs sent by a test client.
    virtual ::grpc::Status GetClientStats(::grpc::ServerContext* context, const ::grpc::testing::LoadBalancerStatsRequest* request, ::grpc::testing::LoadBalancerStatsResponse* response);
    // Gets the accumulated stats for RPCs sent by a test client.
    virtual ::grpc::Status GetClientAccumulatedStats(::grpc::ServerContext* context, const ::grpc::testing::LoadBalancerAccumulatedStatsRequest* request, ::grpc::testing::LoadBalancerAccumulatedStatsResponse* response);
  };
  template <class BaseClass>
  class WithAsyncMethod_GetClientStats : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status GetClientStats(::grpc::ServerContext* /*context*/, const ::grpc::testing::LoadBalancerStatsRequest* /*request*/, ::grpc::testing::LoadBalancerStatsResponse* /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestGetClientStats(::grpc::ServerContext* context, ::grpc::testing::LoadBalancerStatsRequest* request, ::grpc::ServerAsyncResponseWriter< ::grpc::testing::LoadBalancerStatsResponse>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(0, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  class WithAsyncMethod_GetClientAccumulatedStats : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status GetClientAccumulatedStats(::grpc::ServerContext* /*context*/, const ::grpc::testing::LoadBalancerAccumulatedStatsRequest* /*request*/, ::grpc::testing::LoadBalancerAccumulatedStatsResponse* /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestGetClientAccumulatedStats(::grpc::ServerContext* context, ::grpc::testing::LoadBalancerAccumulatedStatsRequest* request, ::grpc::ServerAsyncResponseWriter< ::grpc::testing::LoadBalancerAccumulatedStatsResponse>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(1, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  ...
  class WithCallbackMethod_GetClientStats : public BaseClass {
   ...
   public:
    WithCallbackMethod_GetClientStats() {
      ::grpc::Service::MarkMethodCallback(0,
          new ::grpc::internal::CallbackUnaryHandler< ::grpc::testing::LoadBalancerStatsRequest, ::grpc::testing::LoadBalancerStatsResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::grpc::testing::LoadBalancerStatsRequest* request, ::grpc::testing::LoadBalancerStatsResponse* response) { return this->GetClientStats(context, request, response); }));}
    void SetMessageAllocatorFor_GetClientStats(
        ::grpc::MessageAllocator< ::grpc::testing::LoadBalancerStatsRequest, ::grpc::testing::LoadBalancerStatsResponse>* allocator) {
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(0);
      static_cast<::grpc::internal::CallbackUnaryHandler< ::grpc::testing::LoadBalancerStatsRequest, ::grpc::testing::LoadBalancerStatsResponse>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ...
    virtual ::grpc::ServerUnaryReactor* GetClientStats(
      ::grpc::CallbackServerContext* /*context*/, const ::grpc::testing::LoadBalancerStatsRequest* /*request*/, ::grpc::testing::LoadBalancerStatsResponse* /*response*/)  { return nullptr; }
  };
  template <class BaseClass>
  class WithCallbackMethod_GetClientAccumulatedStats : public BaseClass {
   ...
   public:
    WithCallbackMethod_GetClientAccumulatedStats() {
      ::grpc::Service::MarkMethodCallback(1,
          new ::grpc::internal::CallbackUnaryHandler< ::grpc::testing::LoadBalancerAccumulatedStatsRequest, ::grpc::testing::LoadBalancerAccumulatedStatsResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::grpc::testing::LoadBalancerAccumulatedStatsRequest* request, ::grpc::testing::LoadBalancerAccumulatedStatsResponse* response) { return this->GetClientAccumulatedStats(context, request, response); }));}
    void SetMessageAllocatorFor_GetClientAccumulatedStats(
        ::grpc::MessageAllocator< ::grpc::testing::LoadBalancerAccumulatedStatsRequest, ::grpc::testing::LoadBalancerAccumulatedStatsResponse>* allocator) {
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(1);
      static_cast<::grpc::internal::CallbackUnaryHandler< ::grpc::testing::LoadBalancerAccumulatedStatsRequest, ::grpc::testing::LoadBalancerAccumulatedStatsResponse>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ...
    virtual ::grpc::ServerUnaryReactor* GetClientAccumulatedStats(
      ::grpc::CallbackServerContext* /*context*/, const ::grpc::testing::LoadBalancerAccumulatedStatsRequest* /*request*/, ::grpc::testing::LoadBalancerAccumulatedStatsResponse* /*response*/)  { return nullptr; }
  };
  ...
  class WithStreamedUnaryMethod_GetClientStats : public BaseClass {
   ...
   public:
    WithStreamedUnaryMethod_GetClientStats() {
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::internal::StreamedUnaryHandler<
          ::grpc::testing::LoadBalancerStatsRequest, ::grpc::testing::LoadBalancerStatsResponse>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerUnaryStreamer<
                     ::grpc::testing::LoadBalancerStatsRequest, ::grpc::testing::LoadBalancerStatsResponse>* streamer) {
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status StreamedGetClientStats(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::grpc::testing::LoadBalancerStatsRequest,::grpc::testing::LoadBalancerStatsResponse>* server_unary_streamer) = 0;
  };
  template <class BaseClass>
  class WithStreamedUnaryMethod_GetClientAccumulatedStats : public BaseClass {
   ...
   public:
    WithStreamedUnaryMethod_GetClientAccumulatedStats() {
      ::grpc::Service::MarkMethodStreamed(1,
        new ::grpc::internal::StreamedUnaryHandler<
          ::grpc::testing::LoadBalancerAccumulatedStatsRequest, ::grpc::testing::LoadBalancerAccumulatedStatsResponse>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerUnaryStreamer<
                     ::grpc::testing::LoadBalancerAccumulatedStatsRequest, ::grpc::testing::LoadBalancerAccumulatedStatsResponse>* streamer) {
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status StreamedGetClientAccumulatedStats(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::grpc::testing::LoadBalancerAccumulatedStatsRequest,::grpc::testing::LoadBalancerAccumulatedStatsResponse>* server_unary_streamer) = 0;
  };
...
class XdsUpdateHealthService final {
 public:
  static constexpr char const* service_full_name() {
    return "grpc.testing.XdsUpdateHealthService";
  }
  class StubInterface {
   public:
    virtual ~StubInterface() {}
    virtual ::grpc::Status SetServing(::grpc::ClientContext* context, const ::grpc::testing::Empty& request, ::grpc::testing::Empty* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::grpc::testing::Empty>> AsyncSetServing(::grpc::ClientContext* context, const ::grpc::testing::Empty& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::grpc::testing::Empty>>(AsyncSetServingRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::grpc::testing::Empty>> PrepareAsyncSetServing(::grpc::ClientContext* context, const ::grpc::testing::Empty& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::grpc::testing::Empty>>(PrepareAsyncSetServingRaw(context, request, cq));
    }
    virtual ::grpc::Status SetNotServing(::grpc::ClientContext* context, const ::grpc::testing::Empty& request, ::grpc::testing::Empty* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::grpc::testing::Empty>> AsyncSetNotServing(::grpc::ClientContext* context, const ::grpc::testing::Empty& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::grpc::testing::Empty>>(AsyncSetNotServingRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::grpc::testing::Empty>> PrepareAsyncSetNotServing(::grpc::ClientContext* context, const ::grpc::testing::Empty& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::grpc::testing::Empty>>(PrepareAsyncSetNotServingRaw(context, request, cq));
    }
    class async_interface {
     public:
      virtual ~async_interface() {}
      virtual void SetServing(::grpc::ClientContext* context, const ::grpc::testing::Empty* request, ::grpc::testing::Empty* response, std::function<void(::grpc::Status)>) = 0;
      virtual void SetServing(::grpc::ClientContext* context, const ::grpc::testing::Empty* request, ::grpc::testing::Empty* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      virtual void SetNotServing(::grpc::ClientContext* context, const ::grpc::testing::Empty* request, ::grpc::testing::Empty* response, std::function<void(::grpc::Status)>) = 0;
      virtual void SetNotServing(::grpc::ClientContext* context, const ::grpc::testing::Empty* request, ::grpc::testing::Empty* response, ::grpc::ClientUnaryReactor* reactor) = 0;
    };
    typedef class async_interface experimental_async_interface;
    virtual class async_interface* async() { return nullptr; }
    class async_interface* experimental_async() { return async(); }
   private:
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::grpc::testing::Empty>* AsyncSetServingRaw(::grpc::ClientContext* context, const ::grpc::testing::Empty& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::grpc::testing::Empty>* PrepareAsyncSetServingRaw(::grpc::ClientContext* context, const ::grpc::testing::Empty& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::grpc::testing::Empty>* AsyncSetNotServingRaw(::grpc::ClientContext* context, const ::grpc::testing::Empty& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::grpc::testing::Empty>* PrepareAsyncSetNotServingRaw(::grpc::ClientContext* context, const ::grpc::testing::Empty& request, ::grpc::CompletionQueue* cq) = 0;
  };
  class Stub final : public StubInterface {
   public:
    Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options = ::grpc::StubOptions());
    ::grpc::Status SetServing(::grpc::ClientContext* context, const ::grpc::testing::Empty& request, ::grpc::testing::Empty* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::grpc::testing::Empty>> AsyncSetServing(::grpc::ClientContext* context, const ::grpc::testing::Empty& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::grpc::testing::Empty>>(AsyncSetServingRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::grpc::testing::Empty>> PrepareAsyncSetServing(::grpc::ClientContext* context, const ::grpc::testing::Empty& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::grpc::testing::Empty>>(PrepareAsyncSetServingRaw(context, request, cq));
    }
    ::grpc::Status SetNotServing(::grpc::ClientContext* context, const ::grpc::testing::Empty& request, ::grpc::testing::Empty* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::grpc::testing::Empty>> AsyncSetNotServing(::grpc::ClientContext* context, const ::grpc::testing::Empty& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::grpc::testing::Empty>>(AsyncSetNotServingRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::grpc::testing::Empty>> PrepareAsyncSetNotServing(::grpc::ClientContext* context, const ::grpc::testing::Empty& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::grpc::testing::Empty>>(PrepareAsyncSetNotServingRaw(context, request, cq));
    }
    class async final :
      public StubInterface::async_interface {
     public:
      void SetServing(::grpc::ClientContext* context, const ::grpc::testing::Empty* request, ::grpc::testing::Empty* response, std::function<void(::grpc::Status)>) override;
      void SetServing(::grpc::ClientContext* context, const ::grpc::testing::Empty* request, ::grpc::testing::Empty* response, ::grpc::ClientUnaryReactor* reactor) override;
      void SetNotServing(::grpc::ClientContext* context, const ::grpc::testing::Empty* request, ::grpc::testing::Empty* response, std::function<void(::grpc::Status)>) override;
      void SetNotServing(::grpc::ClientContext* context, const ::grpc::testing::Empty* request, ::grpc::testing::Empty* response, ::grpc::ClientUnaryReactor* reactor) override;
     private:
      friend class Stub;
      explicit async(Stub* stub): stub_(stub) { }
      Stub* stub() { return stub_; }
   ...
   private:
    std::shared_ptr< ::grpc::ChannelInterface> channel_;
    class async async_stub_{this};
    ::grpc::ClientAsyncResponseReader< ::grpc::testing::Empty>* AsyncSetServingRaw(::grpc::ClientContext* context, const ::grpc::testing::Empty& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::grpc::testing::Empty>* PrepareAsyncSetServingRaw(::grpc::ClientContext* context, const ::grpc::testing::Empty& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::grpc::testing::Empty>* AsyncSetNotServingRaw(::grpc::ClientContext* context, const ::grpc::testing::Empty& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::grpc::testing::Empty>* PrepareAsyncSetNotServingRaw(::grpc::ClientContext* context, const ::grpc::testing::Empty& request, ::grpc::CompletionQueue* cq) override;
  ...
  class Service : public ::grpc::Service {
   public:
    Service();
    virtual ~Service();
    virtual ::grpc::Status SetServing(::grpc::ServerContext* context, const ::grpc::testing::Empty* request, ::grpc::testing::Empty* response);
    virtual ::grpc::Status SetNotServing(::grpc::ServerContext* context, const ::grpc::testing::Empty* request, ::grpc::testing::Empty* response);
  };
  template <class BaseClass>
  class WithAsyncMethod_SetServing : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status SetServing(::grpc::ServerContext* /*context*/, const ::grpc::testing::Empty* /*request*/, ::grpc::testing::Empty* /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestSetServing(::grpc::ServerContext* context, ::grpc::testing::Empty* request, ::grpc::ServerAsyncResponseWriter< ::grpc::testing::Empty>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(0, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  class WithAsyncMethod_SetNotServing : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status SetNotServing(::grpc::ServerContext* /*context*/, const ::grpc::testing::Empty* /*request*/, ::grpc::testing::Empty* /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestSetNotServing(::grpc::ServerContext* context, ::grpc::testing::Empty* request, ::grpc::ServerAsyncResponseWriter< ::grpc::testing::Empty>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(1, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
   ...
   public:
    WithCallbackMethod_SetServing() {
      ::grpc::Service::MarkMethodCallback(0,
          new ::grpc::internal::CallbackUnaryHandler< ::grpc::testing::Empty, ::grpc::testing::Empty>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::grpc::testing::Empty* request, ::grpc::testing::Empty* response) { return this->SetServing(context, request, response); }));}
   ...
   public:
    WithCallbackMethod_SetNotServing() {
      ::grpc::Service::MarkMethodCallback(1,
          new ::grpc::internal::CallbackUnaryHandler< ::grpc::testing::Empty, ::grpc::testing::Empty>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::grpc::testing::Empty* request, ::grpc::testing::Empty* response) { return this->SetNotServing(context, request, response); }));}
  ...
  class WithStreamedUnaryMethod_SetServing : public BaseClass {
   ...
   public:
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status StreamedSetServing(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::grpc::testing::Empty,::grpc::testing::Empty>* server_unary_streamer) = 0;
  };
  template <class BaseClass>
  class WithStreamedUnaryMethod_SetNotServing : public BaseClass {
   ...
   public:
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status StreamedSetNotServing(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::grpc::testing::Empty,::grpc::testing::Empty>* server_unary_streamer) = 0;
  };
...
class XdsUpdateClientConfigureService final {
 public:
  static constexpr char const* service_full_name() {
    return "grpc.testing.XdsUpdateClientConfigureService";
  }
  class StubInterface {
   public:
    virtual ~StubInterface() {}
    // Update the tes client's configuration.
    virtual ::grpc::Status Configure(::grpc::ClientContext* context, const ::grpc::testing::ClientConfigureRequest& request, ::grpc::testing::ClientConfigureResponse* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::grpc::testing::ClientConfigureResponse>> AsyncConfigure(::grpc::ClientContext* context, const ::grpc::testing::ClientConfigureRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::grpc::testing::ClientConfigureResponse>>(AsyncConfigureRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::grpc::testing::ClientConfigureResponse>> PrepareAsyncConfigure(::grpc::ClientContext* context, const ::grpc::testing::ClientConfigureRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::grpc::testing::ClientConfigureResponse>>(PrepareAsyncConfigureRaw(context, request, cq));
    }
    class async_interface {
     public:
      virtual ~async_interface() {}
      // Update the tes client's configuration.
      virtual void Configure(::grpc::ClientContext* context, const ::grpc::testing::ClientConfigureRequest* request, ::grpc::testing::ClientConfigureResponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void Configure(::grpc::ClientContext* context, const ::grpc::testing::ClientConfigureRequest* request, ::grpc::testing::ClientConfigureResponse* response, ::grpc::ClientUnaryReactor* reactor) = 0;
    };
    typedef class async_interface experimental_async_interface;
    virtual class async_interface* async() { return nullptr; }
    class async_interface* experimental_async() { return async(); }
   private:
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::grpc::testing::ClientConfigureResponse>* AsyncConfigureRaw(::grpc::ClientContext* context, const ::grpc::testing::ClientConfigureRequest& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::grpc::testing::ClientConfigureResponse>* PrepareAsyncConfigureRaw(::grpc::ClientContext* context, const ::grpc::testing::ClientConfigureRequest& request, ::grpc::CompletionQueue* cq) = 0;
  };
  class Stub final : public StubInterface {
   public:
    Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options = ::grpc::StubOptions());
    ::grpc::Status Configure(::grpc::ClientContext* context, const ::grpc::testing::ClientConfigureRequest& request, ::grpc::testing::ClientConfigureResponse* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::grpc::testing::ClientConfigureResponse>> AsyncConfigure(::grpc::ClientContext* context, const ::grpc::testing::ClientConfigureRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::grpc::testing::ClientConfigureResponse>>(AsyncConfigureRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::grpc::testing::ClientConfigureResponse>> PrepareAsyncConfigure(::grpc::ClientContext* context, const ::grpc::testing::ClientConfigureRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::grpc::testing::ClientConfigureResponse>>(PrepareAsyncConfigureRaw(context, request, cq));
    }
    class async final :
      public StubInterface::async_interface {
     public:
      void Configure(::grpc::ClientContext* context, const ::grpc::testing::ClientConfigureRequest* request, ::grpc::testing::ClientConfigureResponse* response, std::function<void(::grpc::Status)>) override;
      void Configure(::grpc::ClientContext* context, const ::grpc::testing::ClientConfigureRequest* request, ::grpc::testing::ClientConfigureResponse* response, ::grpc::ClientUnaryReactor* reactor) override;
     private:
      friend class Stub;
      explicit async(Stub* stub): stub_(stub) { }
      Stub* stub() { return stub_; }
   ...
   private:
    std::shared_ptr< ::grpc::ChannelInterface> channel_;
    class async async_stub_{this};
    ::grpc::ClientAsyncResponseReader< ::grpc::testing::ClientConfigureResponse>* AsyncConfigureRaw(::grpc::ClientContext* context, const ::grpc::testing::ClientConfigureRequest& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::grpc::testing::ClientConfigureResponse>* PrepareAsyncConfigureRaw(::grpc::ClientContext* context, const ::grpc::testing::ClientConfigureRequest& request, ::grpc::CompletionQueue* cq) override;
  ...
  class Service : public ::grpc::Service {
   public:
    ...
    virtual ~Service();
    // Update the tes client's configuration.
    virtual ::grpc::Status Configure(::grpc::ServerContext* context, const ::grpc::testing::ClientConfigureRequest* request, ::grpc::testing::ClientConfigureResponse* response);
  };
  template <class BaseClass>
  class WithAsyncMethod_Configure : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status Configure(::grpc::ServerContext* /*context*/, const ::grpc::testing::ClientConfigureRequest* /*request*/, ::grpc::testing::ClientConfigureResponse* /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestConfigure(::grpc::ServerContext* context, ::grpc::testing::ClientConfigureRequest* request, ::grpc::ServerAsyncResponseWriter< ::grpc::testing::ClientConfigureResponse>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(0, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  ...
  class WithCallbackMethod_Configure : public BaseClass {
   ...
   public:
    WithCallbackMethod_Configure() {
      ::grpc::Service::MarkMethodCallback(0,
          new ::grpc::internal::CallbackUnaryHandler< ::grpc::testing::ClientConfigureRequest, ::grpc::testing::ClientConfigureResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::grpc::testing::ClientConfigureRequest* request, ::grpc::testing::ClientConfigureResponse* response) { return this->Configure(context, request, response); }));}
    void SetMessageAllocatorFor_Configure(
        ::grpc::MessageAllocator< ::grpc::testing::ClientConfigureRequest, ::grpc::testing::ClientConfigureResponse>* allocator) {
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(0);
      static_cast<::grpc::internal::CallbackUnaryHandler< ::grpc::testing::ClientConfigureRequest, ::grpc::testing::ClientConfigureResponse>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ...
    virtual ::grpc::ServerUnaryReactor* Configure(
      ::grpc::CallbackServerContext* /*context*/, const ::grpc::testing::ClientConfigureRequest* /*request*/, ::grpc::testing::ClientConfigureResponse* /*response*/)  { return nullptr; }
  };
  ...
  class WithStreamedUnaryMethod_Configure : public BaseClass {
   ...
   public:
    WithStreamedUnaryMethod_Configure() {
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::internal::StreamedUnaryHandler<
          ::grpc::testing::ClientConfigureRequest, ::grpc::testing::ClientConfigureResponse>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerUnaryStreamer<
                     ::grpc::testing::ClientConfigureRequest, ::grpc::testing::ClientConfigureResponse>* streamer) {
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status StreamedConfigure(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::grpc::testing::ClientConfigureRequest,::grpc::testing::ClientConfigureResponse>* server_unary_streamer) = 0;
  };
...
#endif  // GRPC_grpc_2ftesting_2ftest_2eproto__INCLUDED
