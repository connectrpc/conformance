...
const char descriptor_table_protodef_server_2fv1_2fserver_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
    ...
    "\021PROTOCOL_GRPC_WEB\020\002B\255\001\n\rcom.server.v1B\013"
    "ServerProtoP\001ZJgithub.com/connectrpc/con"
    "formance/internal/gen/proto/go/server/v1"
    ";serverv1\242\002\003SXX\252\002\tServer.V1\312\002\tServer\\V1\342"
    "\002\025Server\\V1\\GPBMetadata\352\002\nServer::V1b\006pr"
    "oto3"
};
