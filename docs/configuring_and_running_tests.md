...
Computed 602 test case permutation(s) across 13 server configuration(s).
Running 47 tests with reference-server for server config #1 {HTTP_VERSION_1, PROTOCOL_CONNECT, TLS:false}...
Running 47 tests with reference-server for server config #2 {HTTP_VERSION_1, PROTOCOL_CONNECT, TLS:true}...
Running 46 tests with reference-server for server config #3 {HTTP_VERSION_1, PROTOCOL_GRPC_WEB, TLS:false}...
Running 46 tests with reference-server for server config #4 {HTTP_VERSION_1, PROTOCOL_GRPC_WEB, TLS:true}...
Running 47 tests with reference-server for server config #5 {HTTP_VERSION_2, PROTOCOL_CONNECT, TLS:false}...
Running 47 tests with reference-server for server config #6 {HTTP_VERSION_2, PROTOCOL_CONNECT, TLS:true}...
Running 46 tests with reference-server for server config #7 {HTTP_VERSION_2, PROTOCOL_GRPC, TLS:false}...
Running 46 tests with reference-server for server config #8 {HTTP_VERSION_2, PROTOCOL_GRPC, TLS:true}...
Running 46 tests with reference-server for server config #9 {HTTP_VERSION_2, PROTOCOL_GRPC_WEB, TLS:false}...
Running 46 tests with reference-server for server config #10 {HTTP_VERSION_2, PROTOCOL_GRPC_WEB, TLS:true}...
Running 46 tests with grpc-reference-server for server config #11 {HTTP_VERSION_1, PROTOCOL_GRPC_WEB, TLS:false}...
Running 46 tests with grpc-reference-server for server config #12 {HTTP_VERSION_2, PROTOCOL_GRPC, TLS:false}...
Running 46 tests with grpc-reference-server for server config #13 {HTTP_VERSION_2, PROTOCOL_GRPC_WEB, TLS:false}...
```
