...
* `pem_cert` which should contain the TLS certificate, in PEM format, generated by your server if `use_tls` was set 
   to `true`. Clients will verify this certificate when connecting via TLS. If `use_tls` was set to `false`, this 
