...
import (
	context "context"
	errors "errors"
	conformance "github.com/bufbuild/connect-crosstest/internal/gen/proto/go/connect/conformance"
...
const (
	...
	TestServiceUnimplementedStreamingOutputCallProcedure = "/connect.conformance.TestService/UnimplementedStreamingOutputCall"
	...
	UnimplementedServiceUnimplementedCallProcedure = "/connect.conformance.UnimplementedService/UnimplementedCall"
	...
	UnimplementedServiceUnimplementedStreamingOutputCallProcedure = "/connect.conformance.UnimplementedService/UnimplementedStreamingOutputCall"
	// ReconnectServiceStartProcedure is the fully-qualified name of the ReconnectService's Start RPC.
	ReconnectServiceStartProcedure = "/connect.conformance.ReconnectService/Start"
	// ReconnectServiceStopProcedure is the fully-qualified name of the ReconnectService's Stop RPC.
	ReconnectServiceStopProcedure = "/connect.conformance.ReconnectService/Stop"
	...
	LoadBalancerStatsServiceGetClientStatsProcedure = "/connect.conformance.LoadBalancerStatsService/GetClientStats"
	...
	LoadBalancerStatsServiceGetClientAccumulatedStatsProcedure = "/connect.conformance.LoadBalancerStatsService/GetClientAccumulatedStats"
	// XdsUpdateHealthServiceSetServingProcedure is the fully-qualified name of the
	// XdsUpdateHealthService's SetServing RPC.
	XdsUpdateHealthServiceSetServingProcedure = "/connect.conformance.XdsUpdateHealthService/SetServing"
	...
	XdsUpdateHealthServiceSetNotServingProcedure = "/connect.conformance.XdsUpdateHealthService/SetNotServing"
	...
	XdsUpdateClientConfigureServiceConfigureProcedure = "/connect.conformance.XdsUpdateClientConfigureService/Configure"
)

// TestServiceClient is a client for the connect.conformance.TestService service.
...
// NewTestServiceClient constructs a client for the connect.conformance.TestService service. By
...
// EmptyCall calls connect.conformance.TestService.EmptyCall.
...
// UnaryCall calls connect.conformance.TestService.UnaryCall.
...
// FailUnaryCall calls connect.conformance.TestService.FailUnaryCall.
...
// CacheableUnaryCall calls connect.conformance.TestService.CacheableUnaryCall.
...
// StreamingOutputCall calls connect.conformance.TestService.StreamingOutputCall.
...
// FailStreamingOutputCall calls connect.conformance.TestService.FailStreamingOutputCall.
...
// StreamingInputCall calls connect.conformance.TestService.StreamingInputCall.
...
// FullDuplexCall calls connect.conformance.TestService.FullDuplexCall.
...
// HalfDuplexCall calls connect.conformance.TestService.HalfDuplexCall.
...
// UnimplementedCall calls connect.conformance.TestService.UnimplementedCall.
...
// TestServiceHandler is an implementation of the connect.conformance.TestService service.
...
func NewTestServiceHandler(svc TestServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/connect.conformance.TestService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedTestServiceHandler) EmptyCall(context.Context, *connect_go.Request[emptypb.Empty]) (*connect_go.Response[emptypb.Empty], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("connect.conformance.TestService.EmptyCall is not implemented"))
}
...
func (UnimplementedTestServiceHandler) UnaryCall(context.Context, *connect_go.Request[conformance.SimpleRequest]) (*connect_go.Response[conformance.SimpleResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("connect.conformance.TestService.UnaryCall is not implemented"))
}
...
func (UnimplementedTestServiceHandler) FailUnaryCall(context.Context, *connect_go.Request[conformance.SimpleRequest]) (*connect_go.Response[conformance.SimpleResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("connect.conformance.TestService.FailUnaryCall is not implemented"))
}
...
func (UnimplementedTestServiceHandler) CacheableUnaryCall(context.Context, *connect_go.Request[conformance.SimpleRequest]) (*connect_go.Response[conformance.SimpleResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("connect.conformance.TestService.CacheableUnaryCall is not implemented"))
}
...
func (UnimplementedTestServiceHandler) StreamingOutputCall(context.Context, *connect_go.Request[conformance.StreamingOutputCallRequest], *connect_go.ServerStream[conformance.StreamingOutputCallResponse]) error {
	return connect_go.NewError(connect_go.CodeUnimplemented, errors.New("connect.conformance.TestService.StreamingOutputCall is not implemented"))
}
...
func (UnimplementedTestServiceHandler) FailStreamingOutputCall(context.Context, *connect_go.Request[conformance.StreamingOutputCallRequest], *connect_go.ServerStream[conformance.StreamingOutputCallResponse]) error {
	return connect_go.NewError(connect_go.CodeUnimplemented, errors.New("connect.conformance.TestService.FailStreamingOutputCall is not implemented"))
}
...
func (UnimplementedTestServiceHandler) StreamingInputCall(context.Context, *connect_go.ClientStream[conformance.StreamingInputCallRequest]) (*connect_go.Response[conformance.StreamingInputCallResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("connect.conformance.TestService.StreamingInputCall is not implemented"))
}
...
func (UnimplementedTestServiceHandler) FullDuplexCall(context.Context, *connect_go.BidiStream[conformance.StreamingOutputCallRequest, conformance.StreamingOutputCallResponse]) error {
	return connect_go.NewError(connect_go.CodeUnimplemented, errors.New("connect.conformance.TestService.FullDuplexCall is not implemented"))
}
...
func (UnimplementedTestServiceHandler) HalfDuplexCall(context.Context, *connect_go.BidiStream[conformance.StreamingOutputCallRequest, conformance.StreamingOutputCallResponse]) error {
	return connect_go.NewError(connect_go.CodeUnimplemented, errors.New("connect.conformance.TestService.HalfDuplexCall is not implemented"))
}
...
func (UnimplementedTestServiceHandler) UnimplementedCall(context.Context, *connect_go.Request[emptypb.Empty]) (*connect_go.Response[emptypb.Empty], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("connect.conformance.TestService.UnimplementedCall is not implemented"))
}
...
func (UnimplementedTestServiceHandler) UnimplementedStreamingOutputCall(context.Context, *connect_go.Request[emptypb.Empty], *connect_go.ServerStream[emptypb.Empty]) error {
	return connect_go.NewError(connect_go.CodeUnimplemented, errors.New("connect.conformance.TestService.UnimplementedStreamingOutputCall is not implemented"))
}

// UnimplementedServiceClient is a client for the connect.conformance.UnimplementedService service.
...
// connect.conformance.UnimplementedService service. By default, it uses the Connect protocol with
...
// UnimplementedCall calls connect.conformance.UnimplementedService.UnimplementedCall.
...
// UnimplementedServiceHandler is an implementation of the connect.conformance.UnimplementedService
// service.
...
func NewUnimplementedServiceHandler(svc UnimplementedServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/connect.conformance.UnimplementedService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedUnimplementedServiceHandler) UnimplementedCall(context.Context, *connect_go.Request[emptypb.Empty]) (*connect_go.Response[emptypb.Empty], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("connect.conformance.UnimplementedService.UnimplementedCall is not implemented"))
}
...
func (UnimplementedUnimplementedServiceHandler) UnimplementedStreamingOutputCall(context.Context, *connect_go.Request[emptypb.Empty], *connect_go.ServerStream[emptypb.Empty]) error {
	return connect_go.NewError(connect_go.CodeUnimplemented, errors.New("connect.conformance.UnimplementedService.UnimplementedStreamingOutputCall is not implemented"))
}

// ReconnectServiceClient is a client for the connect.conformance.ReconnectService service.
...
// NewReconnectServiceClient constructs a client for the connect.conformance.ReconnectService
...
// Start calls connect.conformance.ReconnectService.Start.
...
// Stop calls connect.conformance.ReconnectService.Stop.
...
// ReconnectServiceHandler is an implementation of the connect.conformance.ReconnectService service.
...
func NewReconnectServiceHandler(svc ReconnectServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/connect.conformance.ReconnectService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedReconnectServiceHandler) Start(context.Context, *connect_go.Request[conformance.ReconnectParams]) (*connect_go.Response[emptypb.Empty], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("connect.conformance.ReconnectService.Start is not implemented"))
}
...
func (UnimplementedReconnectServiceHandler) Stop(context.Context, *connect_go.Request[emptypb.Empty]) (*connect_go.Response[conformance.ReconnectInfo], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("connect.conformance.ReconnectService.Stop is not implemented"))
}

// LoadBalancerStatsServiceClient is a client for the connect.conformance.LoadBalancerStatsService
// service.
...
// connect.conformance.LoadBalancerStatsService service. By default, it uses the Connect protocol
...
// GetClientStats calls connect.conformance.LoadBalancerStatsService.GetClientStats.
...
// connect.conformance.LoadBalancerStatsService service.
...
func NewLoadBalancerStatsServiceHandler(svc LoadBalancerStatsServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/connect.conformance.LoadBalancerStatsService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedLoadBalancerStatsServiceHandler) GetClientStats(context.Context, *connect_go.Request[conformance.LoadBalancerStatsRequest]) (*connect_go.Response[conformance.LoadBalancerStatsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("connect.conformance.LoadBalancerStatsService.GetClientStats is not implemented"))
}
...
func (UnimplementedLoadBalancerStatsServiceHandler) GetClientAccumulatedStats(context.Context, *connect_go.Request[conformance.LoadBalancerAccumulatedStatsRequest]) (*connect_go.Response[conformance.LoadBalancerAccumulatedStatsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("connect.conformance.LoadBalancerStatsService.GetClientAccumulatedStats is not implemented"))
}

// XdsUpdateHealthServiceClient is a client for the connect.conformance.XdsUpdateHealthService
// service.
...
// connect.conformance.XdsUpdateHealthService service. By default, it uses the Connect protocol with
// the binary Protobuf Codec, asks for gzipped responses, and sends uncompressed requests. To use
// the gRPC or gRPC-Web protocols, supply the connect.WithGRPC() or connect.WithGRPCWeb() options.
//
// The URL supplied here should be the base URL for the Connect or gRPC server (for example,
...
// SetServing calls connect.conformance.XdsUpdateHealthService.SetServing.
...
// SetNotServing calls connect.conformance.XdsUpdateHealthService.SetNotServing.
...
// connect.conformance.XdsUpdateHealthService service.
...
func NewXdsUpdateHealthServiceHandler(svc XdsUpdateHealthServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/connect.conformance.XdsUpdateHealthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedXdsUpdateHealthServiceHandler) SetServing(context.Context, *connect_go.Request[emptypb.Empty]) (*connect_go.Response[emptypb.Empty], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("connect.conformance.XdsUpdateHealthService.SetServing is not implemented"))
}
...
func (UnimplementedXdsUpdateHealthServiceHandler) SetNotServing(context.Context, *connect_go.Request[emptypb.Empty]) (*connect_go.Response[emptypb.Empty], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("connect.conformance.XdsUpdateHealthService.SetNotServing is not implemented"))
}

// XdsUpdateClientConfigureServiceClient is a client for the
// connect.conformance.XdsUpdateClientConfigureService service.
...
// connect.conformance.XdsUpdateClientConfigureService service. By default, it uses the Connect
...
// Configure calls connect.conformance.XdsUpdateClientConfigureService.Configure.
...
func NewXdsUpdateClientConfigureServiceHandler(svc XdsUpdateClientConfigureServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/connect.conformance.XdsUpdateClientConfigureService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedXdsUpdateClientConfigureServiceHandler) Configure(context.Context, *connect_go.Request[conformance.ClientConfigureRequest]) (*connect_go.Response[conformance.ClientConfigureResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("connect.conformance.XdsUpdateClientConfigureService.Configure is not implemented"))
}
