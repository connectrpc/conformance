...
type ConformanceServiceClient interface {
	...
	Unary(context.Context, *connect.Request[v1alpha1.UnaryRequest]) (*connect.Response[v1alpha1.UnaryResponse], error)
	...
	ServerStream(context.Context, *connect.Request[v1alpha1.ServerStreamRequest]) (*connect.ServerStreamForClient[v1alpha1.ServerStreamResponse], error)
	// Servers should allow the response definition to be unset in the request and
	// if it is, set no response headers or trailers and send back empty response data.
	ClientStream(context.Context) *connect.ClientStreamForClient[v1alpha1.ClientStreamRequest, v1alpha1.ClientStreamResponse]
...
func NewConformanceServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ConformanceServiceClient {
	...
	return &conformanceServiceClient{
		unary: connect.NewClient[v1alpha1.UnaryRequest, v1alpha1.UnaryResponse](
			httpClient,
			baseURL+ConformanceServiceUnaryProcedure,
			opts...,
		),
		serverStream: connect.NewClient[v1alpha1.ServerStreamRequest, v1alpha1.ServerStreamResponse](
			httpClient,
			baseURL+ConformanceServiceServerStreamProcedure,
			opts...,
		),
		clientStream: connect.NewClient[v1alpha1.ClientStreamRequest, v1alpha1.ClientStreamResponse](
			httpClient,
			baseURL+ConformanceServiceClientStreamProcedure,
			opts...,
		),
		bidiStream: connect.NewClient[v1alpha1.BidiStreamRequest, v1alpha1.BidiStreamResponse](
			httpClient,
...
func (c *conformanceServiceClient) Unary(ctx context.Context, req *connect.Request[v1alpha1.UnaryRequest]) (*connect.Response[v1alpha1.UnaryResponse], error) {
	return c.unary.CallUnary(ctx, req)
}

// ServerStream calls connectrpc.conformance.v1alpha1.ConformanceService.ServerStream.
func (c *conformanceServiceClient) ServerStream(ctx context.Context, req *connect.Request[v1alpha1.ServerStreamRequest]) (*connect.ServerStreamForClient[v1alpha1.ServerStreamResponse], error) {
...
func (c *conformanceServiceClient) ClientStream(ctx context.Context) *connect.ClientStreamForClient[v1alpha1.ClientStreamRequest, v1alpha1.ClientStreamResponse] {
...
type ConformanceServiceHandler interface {
	...
	// if so, all responses should contain no response headers or trailers and
	// contain empty response data.
	ServerStream(context.Context, *connect.Request[v1alpha1.ServerStreamRequest], *connect.ServerStream[v1alpha1.ServerStreamResponse]) error
	// Servers should allow the response definition to be unset in the request and
	// if it is, set no response headers or trailers and send back empty response data.
	ClientStream(context.Context, *connect.ClientStream[v1alpha1.ClientStreamRequest]) (*connect.Response[v1alpha1.ClientStreamResponse], error)
	// A bidirectional-streaming operation. The first request indicates the response
	// headers, response messages, trailers, and an optional error to send back.
	// The response data should be sent in the order indicated, and the server
	// should wait between sending response messages as indicated. If the
...
func (UnimplementedConformanceServiceHandler) Unary(context.Context, *connect.Request[v1alpha1.UnaryRequest]) (*connect.Response[v1alpha1.UnaryResponse], error) {
...
func (UnimplementedConformanceServiceHandler) ServerStream(context.Context, *connect.Request[v1alpha1.ServerStreamRequest], *connect.ServerStream[v1alpha1.ServerStreamResponse]) error {
...
func (UnimplementedConformanceServiceHandler) ClientStream(context.Context, *connect.ClientStream[v1alpha1.ClientStreamRequest]) (*connect.Response[v1alpha1.ClientStreamResponse], error) {
