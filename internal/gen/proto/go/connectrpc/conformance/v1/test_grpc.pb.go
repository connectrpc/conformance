...
func (c *testServiceClient) EmptyCall(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/connectrpc.conformance.v1.TestService/EmptyCall", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *testServiceClient) UnaryCall(ctx context.Context, in *SimpleRequest, opts ...grpc.CallOption) (*SimpleResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/connectrpc.conformance.v1.TestService/UnaryCall", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *testServiceClient) FailUnaryCall(ctx context.Context, in *SimpleRequest, opts ...grpc.CallOption) (*SimpleResponse, error) {
	out := new(SimpleResponse)
	err := c.cc.Invoke(ctx, "/connectrpc.conformance.v1.TestService/FailUnaryCall", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *testServiceClient) CacheableUnaryCall(ctx context.Context, in *SimpleRequest, opts ...grpc.CallOption) (*SimpleResponse, error) {
	out := new(SimpleResponse)
	err := c.cc.Invoke(ctx, "/connectrpc.conformance.v1.TestService/CacheableUnaryCall", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *testServiceClient) StreamingOutputCall(ctx context.Context, in *StreamingOutputCallRequest, opts ...grpc.CallOption) (TestService_StreamingOutputCallClient, error) {
	stream, err := c.cc.NewStream(ctx, &TestService_ServiceDesc.Streams[0], "/connectrpc.conformance.v1.TestService/StreamingOutputCall", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *testServiceClient) FailStreamingOutputCall(ctx context.Context, in *StreamingOutputCallRequest, opts ...grpc.CallOption) (TestService_FailStreamingOutputCallClient, error) {
	stream, err := c.cc.NewStream(ctx, &TestService_ServiceDesc.Streams[1], "/connectrpc.conformance.v1.TestService/FailStreamingOutputCall", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *testServiceClient) StreamingInputCall(ctx context.Context, opts ...grpc.CallOption) (TestService_StreamingInputCallClient, error) {
	stream, err := c.cc.NewStream(ctx, &TestService_ServiceDesc.Streams[2], "/connectrpc.conformance.v1.TestService/StreamingInputCall", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *testServiceClient) FullDuplexCall(ctx context.Context, opts ...grpc.CallOption) (TestService_FullDuplexCallClient, error) {
	stream, err := c.cc.NewStream(ctx, &TestService_ServiceDesc.Streams[3], "/connectrpc.conformance.v1.TestService/FullDuplexCall", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *testServiceClient) HalfDuplexCall(ctx context.Context, opts ...grpc.CallOption) (TestService_HalfDuplexCallClient, error) {
	stream, err := c.cc.NewStream(ctx, &TestService_ServiceDesc.Streams[4], "/connectrpc.conformance.v1.TestService/HalfDuplexCall", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *testServiceClient) UnimplementedCall(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/connectrpc.conformance.v1.TestService/UnimplementedCall", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *testServiceClient) UnimplementedStreamingOutputCall(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (TestService_UnimplementedStreamingOutputCallClient, error) {
	stream, err := c.cc.NewStream(ctx, &TestService_ServiceDesc.Streams[5], "/connectrpc.conformance.v1.TestService/UnimplementedStreamingOutputCall", opts...)
	if err != nil {
		return nil, err
	}
...
func _TestService_EmptyCall_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/connectrpc.conformance.v1.TestService/EmptyCall",
	}
...
func _TestService_UnaryCall_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/connectrpc.conformance.v1.TestService/UnaryCall",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TestService_FailUnaryCall_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/connectrpc.conformance.v1.TestService/FailUnaryCall",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TestService_CacheableUnaryCall_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/connectrpc.conformance.v1.TestService/CacheableUnaryCall",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TestService_UnimplementedCall_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/connectrpc.conformance.v1.TestService/UnimplementedCall",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var TestService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "connectrpc.conformance.v1.TestService",
	...
	Metadata: "connectrpc/conformance/v1/test.proto",
}
...
func (c *unimplementedServiceClient) UnimplementedCall(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/connectrpc.conformance.v1.UnimplementedService/UnimplementedCall", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *unimplementedServiceClient) UnimplementedStreamingOutputCall(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (UnimplementedService_UnimplementedStreamingOutputCallClient, error) {
	stream, err := c.cc.NewStream(ctx, &UnimplementedService_ServiceDesc.Streams[0], "/connectrpc.conformance.v1.UnimplementedService/UnimplementedStreamingOutputCall", opts...)
	if err != nil {
		return nil, err
	}
...
func _UnimplementedService_UnimplementedCall_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/connectrpc.conformance.v1.UnimplementedService/UnimplementedCall",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var UnimplementedService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "connectrpc.conformance.v1.UnimplementedService",
...
func (c *reconnectServiceClient) Start(ctx context.Context, in *ReconnectParams, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/connectrpc.conformance.v1.ReconnectService/Start", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reconnectServiceClient) Stop(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ReconnectInfo, error) {
	...
	err := c.cc.Invoke(ctx, "/connectrpc.conformance.v1.ReconnectService/Stop", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ReconnectService_Start_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/connectrpc.conformance.v1.ReconnectService/Start",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ReconnectService_Stop_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/connectrpc.conformance.v1.ReconnectService/Stop",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var ReconnectService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "connectrpc.conformance.v1.ReconnectService",
...
func (c *loadBalancerStatsServiceClient) GetClientStats(ctx context.Context, in *LoadBalancerStatsRequest, opts ...grpc.CallOption) (*LoadBalancerStatsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/connectrpc.conformance.v1.LoadBalancerStatsService/GetClientStats", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *loadBalancerStatsServiceClient) GetClientAccumulatedStats(ctx context.Context, in *LoadBalancerAccumulatedStatsRequest, opts ...grpc.CallOption) (*LoadBalancerAccumulatedStatsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/connectrpc.conformance.v1.LoadBalancerStatsService/GetClientAccumulatedStats", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _LoadBalancerStatsService_GetClientStats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/connectrpc.conformance.v1.LoadBalancerStatsService/GetClientStats",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _LoadBalancerStatsService_GetClientAccumulatedStats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/connectrpc.conformance.v1.LoadBalancerStatsService/GetClientAccumulatedStats",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var LoadBalancerStatsService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "connectrpc.conformance.v1.LoadBalancerStatsService",
...
func (c *xdsUpdateHealthServiceClient) SetServing(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/connectrpc.conformance.v1.XdsUpdateHealthService/SetServing", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *xdsUpdateHealthServiceClient) SetNotServing(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/connectrpc.conformance.v1.XdsUpdateHealthService/SetNotServing", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _XdsUpdateHealthService_SetServing_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/connectrpc.conformance.v1.XdsUpdateHealthService/SetServing",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _XdsUpdateHealthService_SetNotServing_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/connectrpc.conformance.v1.XdsUpdateHealthService/SetNotServing",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var XdsUpdateHealthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "connectrpc.conformance.v1.XdsUpdateHealthService",
...
func (c *xdsUpdateClientConfigureServiceClient) Configure(ctx context.Context, in *ClientConfigureRequest, opts ...grpc.CallOption) (*ClientConfigureResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/connectrpc.conformance.v1.XdsUpdateClientConfigureService/Configure", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _XdsUpdateClientConfigureService_Configure_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/connectrpc.conformance.v1.XdsUpdateClientConfigureService/Configure",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var XdsUpdateClientConfigureService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "connectrpc.conformance.v1.XdsUpdateClientConfigureService",
