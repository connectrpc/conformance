...
type TestSuite struct {
	...
	RelevantProtocols []Protocol `protobuf:"varint,3,rep,packed,name=relevant_protocols,json=relevantProtocols,proto3,enum=connectrpc.conformance.v1alpha1.Protocol" json:"relevant_protocols,omitempty"`
	// If non-empty, the HTTP versions to which this suite applies. If empty,
	// this suite applies to all HTTP versions.
	RelevantHttpVersions []HTTPVersion `protobuf:"varint,4,rep,packed,name=relevant_http_versions,json=relevantHttpVersions,proto3,enum=connectrpc.conformance.v1alpha1.HTTPVersion" json:"relevant_http_versions,omitempty"`
	// If non-empty, the codecs to which this suite applies. If empty, this
	// suite applies to all codecs.
	RelevantCodecs []Codec `protobuf:"varint,5,rep,packed,name=relevant_codecs,json=relevantCodecs,proto3,enum=connectrpc.conformance.v1alpha1.Codec" json:"relevant_codecs,omitempty"`
	// If non-empty, the compression encodings to which this suite applies.
	// If empty, this suite applies to all encodings.
	RelevantCompressions []Compression `protobuf:"varint,6,rep,packed,name=relevant_compressions,json=relevantCompressions,proto3,enum=connectrpc.conformance.v1alpha1.Compression" json:"relevant_compressions,omitempty"`
	// If true, the cases in this suite rely on TLS.
	ReliesOnTls bool `protobuf:"varint,7,opt,name=relies_on_tls,json=reliesOnTls,proto3" json:"relies_on_tls,omitempty"`
	// If true, the cases in this suite rely on the Connect GET protocol.
	ReliesOnConnectGet bool `protobuf:"varint,8,opt,name=relies_on_connect_get,json=reliesOnConnectGet,proto3" json:"relies_on_connect_get,omitempty"`
	// Indicates the Connect version validation behavior that this suite
	// relies on.
	ConnectVersionMode TestSuite_ConnectVersionMode `protobuf:"varint,9,opt,name=connect_version_mode,json=connectVersionMode,proto3,enum=connectrpc.conformance.v1alpha1.TestSuite_ConnectVersionMode" json:"connect_version_mode,omitempty"`
	TestCases          []*TestCase                  `protobuf:"bytes,10,rep,name=test_cases,json=testCases,proto3" json:"test_cases,omitempty"`
}
...
var file_connectrpc_conformance_v1alpha1_suite_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0xbe, 0x07, 0x0a, 0x09, 0x54, 0x65, 0x73, 0x74, 0x53, 0x75, 0x69, 0x74, 0x65, 0x12,
	...
	,
	...
	,
	...
	0x10, 0x02, 0x22, 0xbe, 0x01, 0x0a, 0x08, 0x54, 0x65, 0x73, 0x74, 0x43, 0x61, 0x73, 0x65, 0x12,
	...
	,
...
var file_connectrpc_conformance_v1alpha1_suite_proto_goTypes = []interface{}{
	...
	(*ClientCompatRequest)(nil),       // 8: connectrpc.conformance.v1alpha1.ClientCompatRequest
	(*ClientResponseResult)(nil),      // 9: connectrpc.conformance.v1alpha1.ClientResponseResult
}
var file_connectrpc_conformance_v1alpha1_suite_proto_depIdxs = []int32{
	...
	4, // 1: connectrpc.conformance.v1alpha1.TestSuite.relevant_protocols:type_name -> connectrpc.conformance.v1alpha1.Protocol
	5, // 2: connectrpc.conformance.v1alpha1.TestSuite.relevant_http_versions:type_name -> connectrpc.conformance.v1alpha1.HTTPVersion
	6, // 3: connectrpc.conformance.v1alpha1.TestSuite.relevant_codecs:type_name -> connectrpc.conformance.v1alpha1.Codec
	7, // 4: connectrpc.conformance.v1alpha1.TestSuite.relevant_compressions:type_name -> connectrpc.conformance.v1alpha1.Compression
	1, // 5: connectrpc.conformance.v1alpha1.TestSuite.connect_version_mode:type_name -> connectrpc.conformance.v1alpha1.TestSuite.ConnectVersionMode
	3, // 6: connectrpc.conformance.v1alpha1.TestSuite.test_cases:type_name -> connectrpc.conformance.v1alpha1.TestCase
	8, // 7: connectrpc.conformance.v1alpha1.TestCase.request:type_name -> connectrpc.conformance.v1alpha1.ClientCompatRequest
	9, // 8: connectrpc.conformance.v1alpha1.TestCase.expected_response:type_name -> connectrpc.conformance.v1alpha1.ClientResponseResult
