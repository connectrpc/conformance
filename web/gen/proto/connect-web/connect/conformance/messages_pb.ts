...
// @generated from file connect/conformance/messages.proto (package connect.conformance, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from enum connect.conformance.PayloadType
 */
...
proto3.util.setEnumType(PayloadType, "connect.conformance.PayloadType", [
 ...
 *
 * @generated from enum connect.conformance.GrpclbRouteType
 */
...
proto3.util.setEnumType(GrpclbRouteType, "connect.conformance.GrpclbRouteType", [
 ...
 *
 * @generated from message connect.conformance.Payload
 */
export class Payload extends Message<Payload> {
  /**
   * The type of data in body.
   *
   * @generated from field: connect.conformance.PayloadType type = 1;
   */
  ...
  static readonly typeName = "connect.conformance.Payload";
 ...
 *
 * @generated from message connect.conformance.EchoStatus
 */
export class EchoStatus extends Message<EchoStatus> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "connect.conformance.EchoStatus";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * Unary request.
 *
 * @generated from message connect.conformance.SimpleRequest
 */
export class SimpleRequest extends Message<SimpleRequest> {
   ...
   *
   * @generated from field: connect.conformance.PayloadType response_type = 1;
   */
   ...
   *
   * @generated from field: connect.conformance.Payload payload = 3;
   */
  payload?: Payload;
   ...
   *
   * @generated from field: connect.conformance.EchoStatus response_status = 7;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "connect.conformance.SimpleRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message connect.conformance.SimpleResponse
 */
export class SimpleResponse extends Message<SimpleResponse> {
  /**
   * Payload to increase message size.
   *
   * @generated from field: connect.conformance.Payload payload = 1;
   */
  payload?: Payload;
   ...
   * gRPCLB Path.
   *
   * @generated from field: connect.conformance.GrpclbRouteType grpclb_route_type = 5;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "connect.conformance.SimpleResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message connect.conformance.StreamingInputCallRequest
 */
export class StreamingInputCallRequest extends Message<StreamingInputCallRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "connect.conformance.StreamingInputCallRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "payload", kind: "message", T: Payload },
 ...
 *
 * @generated from message connect.conformance.StreamingInputCallResponse
 */
export class StreamingInputCallResponse extends Message<StreamingInputCallResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "connect.conformance.StreamingInputCallResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message connect.conformance.ResponseParameters
 */
export class ResponseParameters extends Message<ResponseParameters> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "connect.conformance.ResponseParameters";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message connect.conformance.StreamingOutputCallRequest
 */
export class StreamingOutputCallRequest extends Message<StreamingOutputCallRequest> {
   ...
   *
   * @generated from field: repeated connect.conformance.ResponseParameters response_parameters = 2;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "connect.conformance.StreamingOutputCallRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "response_type", kind: "enum", T: proto3.getEnumType(PayloadType) },
 ...
 *
 * @generated from message connect.conformance.StreamingOutputCallResponse
 */
export class StreamingOutputCallResponse extends Message<StreamingOutputCallResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "connect.conformance.StreamingOutputCallResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "payload", kind: "message", T: Payload },
  ]);
 ...
 *
 * @generated from message connect.conformance.ReconnectParams
 */
export class ReconnectParams extends Message<ReconnectParams> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "connect.conformance.ReconnectParams";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message connect.conformance.ReconnectInfo
 */
export class ReconnectInfo extends Message<ReconnectInfo> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "connect.conformance.ReconnectInfo";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message connect.conformance.LoadBalancerStatsRequest
 */
export class LoadBalancerStatsRequest extends Message<LoadBalancerStatsRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "connect.conformance.LoadBalancerStatsRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message connect.conformance.LoadBalancerStatsResponse
 */
export class LoadBalancerStatsResponse extends Message<LoadBalancerStatsResponse> {
  ...
  /**
   * @generated from field: map<string, connect.conformance.LoadBalancerStatsResponse.RpcsByPeer> rpcs_by_method = 3;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "connect.conformance.LoadBalancerStatsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message connect.conformance.LoadBalancerStatsResponse.RpcsByPeer
 */
export class LoadBalancerStatsResponse_RpcsByPeer extends Message<LoadBalancerStatsResponse_RpcsByPeer> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "connect.conformance.LoadBalancerStatsResponse.RpcsByPeer";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "rpcs_by_peer", kind: "map", K: 9 /* ScalarType.STRING */, V: {kind: "scalar", T: 5 /* ScalarType.INT32 */} },
  ]);
 ...
 *
 * @generated from message connect.conformance.LoadBalancerAccumulatedStatsRequest
 */
export class LoadBalancerAccumulatedStatsRequest extends Message<LoadBalancerAccumulatedStatsRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "connect.conformance.LoadBalancerAccumulatedStatsRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
 ...
 *
 * @generated from message connect.conformance.LoadBalancerAccumulatedStatsResponse
 */
export class LoadBalancerAccumulatedStatsResponse extends Message<LoadBalancerAccumulatedStatsResponse> {
   ...
   *
   * @generated from field: map<string, connect.conformance.LoadBalancerAccumulatedStatsResponse.MethodStats> stats_per_method = 4;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "connect.conformance.LoadBalancerAccumulatedStatsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message connect.conformance.LoadBalancerAccumulatedStatsResponse.MethodStats
 */
export class LoadBalancerAccumulatedStatsResponse_MethodStats extends Message<LoadBalancerAccumulatedStatsResponse_MethodStats> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "connect.conformance.LoadBalancerAccumulatedStatsResponse.MethodStats";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message connect.conformance.ClientConfigureRequest
 */
export class ClientConfigureRequest extends Message<ClientConfigureRequest> {
  /**
   * The types of RPCs the client sends.
   *
   * @generated from field: repeated connect.conformance.ClientConfigureRequest.RpcType types = 1;
   */
   ...
   *
   * @generated from field: repeated connect.conformance.ClientConfigureRequest.Metadata metadata = 2;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "connect.conformance.ClientConfigureRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from enum connect.conformance.ClientConfigureRequest.RpcType
 */
...
proto3.util.setEnumType(ClientConfigureRequest_RpcType, "connect.conformance.ClientConfigureRequest.RpcType", [
 ...
 *
 * @generated from message connect.conformance.ClientConfigureRequest.Metadata
 */
export class ClientConfigureRequest_Metadata extends Message<ClientConfigureRequest_Metadata> {
  /**
   * @generated from field: connect.conformance.ClientConfigureRequest.RpcType type = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "connect.conformance.ClientConfigureRequest.Metadata";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message connect.conformance.ClientConfigureResponse
 */
export class ClientConfigureResponse extends Message<ClientConfigureResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "connect.conformance.ClientConfigureResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message connect.conformance.ErrorDetail
 */
export class ErrorDetail extends Message<ErrorDetail> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "connect.conformance.ErrorDetail";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message connect.conformance.ErrorStatus
 */
export class ErrorStatus extends Message<ErrorStatus> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "connect.conformance.ErrorStatus";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "code", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 2, name: "message", kind: "scalar", T: 9 /* ScalarType.STRING */ },
