...
export class TestServiceClient {
  ...
  methodDescriptorCacheableStreamingOutputCall = new grpcWeb.MethodDescriptor(
    '/grpc.testing.TestService/CacheableStreamingOutputCall',
  ...
  cacheableStreamingOutputCall(
    ...
    return this.client_.serverStreaming(
      ...
      request,
      metadata || {},
      this.methodDescriptorCacheableStreamingOutputCall);
  }
